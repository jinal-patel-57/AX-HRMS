...
<div class="card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                        <div class="form-group-view">
                            <div class="label-name">Aadhar Card</div>
                    ...
                    <c:if test="${not empty kycDocumentFile}">
                         <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                            <div class="form-group-view">
                                <div class="label-name">KYC Document</div>
                                <div class="label-content"> <c:if test="${not empty kycDocumentFile}">  <a target="_blank" href="${kycDocumentFile}">View KYC Document</a></c:if></div>
                            </div>
                         </div>
                    </c:if>
                </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <% Address permanentaddresss=(Address) request.getAttribute("permanentaddresss"); String
                    permanentCountryName="" ; if (permanentaddresss !=null && permanentaddresss.getCountry()> 0) {
                    try {
                    ...
                    <hr>
                        ...
                        <% Address presentaddresss=(Address) request.getAttribute("presentaddresss"); String
                            presentCountryName="" ; if (presentaddresss !=null && presentaddresss.getCountry()> 0) {
                            try {
                            presentCountryName =
                            CountryLocalServiceUtil
