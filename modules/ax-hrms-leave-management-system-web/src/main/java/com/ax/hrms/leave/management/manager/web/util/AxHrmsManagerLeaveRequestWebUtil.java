package com.ax.hrms.leave.management.manager.web.util;
...
import com.ax.hrms.leave.management.employee.web.notification.SendNotificationToUserHandler;
 ...
 */
@Component(immediate = true, service = AxHrmsManagerLeaveRequestWebUtil.class)
public class AxHrmsManagerLeaveRequestWebUtil {
    @Reference
    ...
    private static final Log log = LogFactoryUtil.getLog(AxHrmsManagerLeaveRequestWebUtil.class);
    ...
    public LeaveRequestDto setLeaveRequestData(Long leaveRequestId) throws PortalException {
        ...
        try {
            ...
            EmployeeDepartment emplyeeDepartment = employeeDepartmentLocalService.findByEmployeeId(leaveRequest.getEmployeeId());

            DepartmentMaster departmentMaster = departmentMasterLocalService.getDepartmentMaster(emplyeeDepartment.getDepartmentMasterId());
            leaveRequestDto.setDepartmentName(departmentMaster.getDepartmentName());

            EmployeeDesignation employeeDesiganation = employeeDesignationLocalService.findByEmployeeId(leaveRequest.getEmployeeId());
            DesignationMaster desiganationMaster = designationMasterLocalService.getDesignationMaster(employeeDesiganation.getDesignationMasterId());
            ...
            LeaveTypeMaster leaveTypeMaster = leaveTypeMasterLocalService.findByLeaveTypeMasterId(leaveRequest.getLeaveTypeMasterId());
    ...
    public StringBuilder getBody(LeaveRequest leaveRequest, EmployeeDetails employee, StringBuilder body) throws PortalException {
        ...
        EmployeeDepartment employeeDepartment = employeeDepartmentLocalService.findByEmployeeId(employee.getEmployeeId());

        DepartmentMaster departmentMaster = departmentMasterLocalService.findByDepartmentNameById(employeeDepartment.getDepartmentMasterId());

        EmployeeDesignation employeeDesignation = employeeDesignationLocalService.findByEmployeeId(employee.getEmployeeId());
        DesignationMaster designationMaster = designationMasterLocalService.findByDesignationNameById(employeeDesignation.getDesignationMasterId());

        // FETCH DATA OF STATUS
        LeaveCompensatoryStatusMaster status = leaveCompensatoryStatusMasterLocalService.findByLeaveCompensatoryStatusById(leaveRequest.getLeaveCompensatoryStatusMasterId());
    ...
    public void updateLeaveBalance(int currentYear, long employeeId, long leaveTypeMasterId, double totalDays) throws NoSuchLeaveBalanceException {
        LeaveBalance leaveBalance;
        leaveBalance = leaveBalanceLocalService.findByEmployeeIdLeaveTypeMasterIdAndYear(employeeId, leaveTypeMasterId, currentYear);
    ...
    public void sendMailtoTeam(String fromName, String fromEmailAddress, Long leaveRequestId, StringBuilder body, MailTemplateConfiguration mailTemplateConfiguration) {
        try {
            ...
            for (LeaveInformToTeamDetail leaveInformDetail : leaveInformToTeamDetailList) {
                ...
                axHrmsCommonApi.sendMail(teamMember.getOfficialEmail(), fromEmailAddress, fromName, subject, mailContent);
            }
        } catch (Exception e) {
    ...
    public void sendNotificationToEmployee(String body, EmployeeDetails employee) {
        ...
        try {
            ...
            // Notification........
            UserNotificationEvent userNotification = UserNotificationEventLocalServiceUtil.sendUserNotificationEvents(employee.getLrUserId(), AxHrmsLeaveManagementSystemWebPortletKeys.AXHRMS_MANAGER_LEAVE_MANAGEMENT_SYSTEM_WEB_PORTLET, UserNotificationDeliveryConstants.TYPE_WEBSITE, notificationJSON);
