            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                    <div class="form-group-view">
                        ...
                        <div class="label-content email">${empty leaveRequestDto ? '' :
                            leaveRequestDto.employeeOfficialMail}</div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                    <div class="form-group-view">
                        ...
                        <div class="label-content">${empty leaveRequestDto ? '' : leaveRequestDto.dateOfRequestedLeave}
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                    <div class="form-group-view">
                        ...
                        <div class="label-content">${empty leaveRequestDto ? '' :
                            leaveRequestDto.startDateOfLeaveRequest}</div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                    <div class="form-group-view">
                        <div class="label-name"><liferay-ui:message key="end-date-of-leave" /></div>
                        <div class="label-content">${empty leaveRequestDto ? '' : leaveRequestDto.endDateOfLeaveRequest}
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${data.halfDay}">
                                                        <p class="my-0">
                                                            <liferay-ui:message key="half-day" /> (<c:choose>
                                                                <c:when test="${data.firstHalf}"><liferay-ui:message
                                                                        key="first-half" /></c:when>
                                                                <c:otherwise><liferay-ui:message key="second-half" />
                                                                </c:otherwise>
                                                            </c:choose>)
                                                        </p>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <p class="my-0"><liferay-ui:message key="full-day" /></p>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                        </tr>
