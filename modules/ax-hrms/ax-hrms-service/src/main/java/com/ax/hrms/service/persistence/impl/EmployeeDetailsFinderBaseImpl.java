 ...
 * @generated
 */
public abstract class EmployeeDetailsFinderBaseImpl
	extends BasePersistenceImpl<EmployeeDetails> {

	public EmployeeDetailsFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return employeeDetailsPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeDetailsFinderBaseImpl.class);
