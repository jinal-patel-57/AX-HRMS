...
import com.ax.hrms.service.AppraisalMeetingInviteesService;
...
/**
 * Provides the base implementation for the appraisal meeting invitees remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalMeetingInviteesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalMeetingInviteesServiceImpl
 * @generated
 */
public abstract class AppraisalMeetingInviteesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalMeetingInviteesService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalMeetingInviteesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalMeetingInviteesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalMeetingInviteesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appraisalMeetingInviteesService =
			(AppraisalMeetingInviteesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalMeetingInviteesService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalMeetingInviteesLocalService
		appraisalMeetingInviteesLocalService;

	protected AppraisalMeetingInviteesService appraisalMeetingInviteesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalMeetingInviteesServiceBaseImpl.class);
