...
import com.ax.hrms.service.EmployeeProbationDetailsService;
...
/**
 * Provides the base implementation for the employee probation details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeProbationDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeProbationDetailsServiceImpl
 * @generated
 */
public abstract class EmployeeProbationDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeProbationDetailsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeProbationDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeProbationDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeProbationDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeProbationDetailsService =
			(EmployeeProbationDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeProbationDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeProbationDetailsLocalService
		employeeProbationDetailsLocalService;

	protected EmployeeProbationDetailsService employeeProbationDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeProbationDetailsServiceBaseImpl.class);
