...
import com.ax.hrms.service.WorkFromHomeDayTypeService;
...
/**
 * Provides the base implementation for the work from home day type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.WorkFromHomeDayTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.WorkFromHomeDayTypeServiceImpl
 * @generated
 */
public abstract class WorkFromHomeDayTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WorkFromHomeDayTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkFromHomeDayTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.WorkFromHomeDayTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkFromHomeDayTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		workFromHomeDayTypeService = (WorkFromHomeDayTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkFromHomeDayTypeService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.WorkFromHomeDayTypeLocalService
		workFromHomeDayTypeLocalService;

	protected WorkFromHomeDayTypeService workFromHomeDayTypeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WorkFromHomeDayTypeServiceBaseImpl.class);
