...
import com.ax.hrms.service.EmployeeOffBoardingService;
...
/**
 * Provides the base implementation for the employee off boarding remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeOffBoardingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeOffBoardingServiceImpl
 * @generated
 */
public abstract class EmployeeOffBoardingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeOffBoardingService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeOffBoardingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeOffBoardingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeOffBoardingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeOffBoardingService = (EmployeeOffBoardingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeOffBoardingService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeOffBoardingLocalService
		employeeOffBoardingLocalService;

	protected EmployeeOffBoardingService employeeOffBoardingService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeOffBoardingServiceBaseImpl.class);
