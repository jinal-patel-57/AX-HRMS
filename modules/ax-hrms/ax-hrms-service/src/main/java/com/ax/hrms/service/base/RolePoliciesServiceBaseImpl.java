...
import com.ax.hrms.service.RolePoliciesService;
...
/**
 * Provides the base implementation for the role policies remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.RolePoliciesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.RolePoliciesServiceImpl
 * @generated
 */
public abstract class RolePoliciesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RolePoliciesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RolePoliciesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.RolePoliciesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RolePoliciesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rolePoliciesService = (RolePoliciesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RolePoliciesService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.RolePoliciesLocalService
		rolePoliciesLocalService;

	protected RolePoliciesService rolePoliciesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RolePoliciesServiceBaseImpl.class);
