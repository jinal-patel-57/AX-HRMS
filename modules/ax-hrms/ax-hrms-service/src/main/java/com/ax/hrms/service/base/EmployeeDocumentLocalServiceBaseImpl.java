...
import com.ax.hrms.service.EmployeeDocumentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeDocumentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeDocumentLocalServiceImpl
 * @generated
 */
public abstract class EmployeeDocumentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDocumentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeDocumentLocalServiceUtil</code>.
	 */
	...
	public EmployeeDocument createEmployeeDocument(long documentId) {
		return employeeDocumentPersistence.create(documentId);
	}
	...
	public EmployeeDocument deleteEmployeeDocument(long documentId)
		...
		return employeeDocumentPersistence.remove(documentId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return employeeDocumentPersistence.dslQuery(dslQuery);
	}
	...
	public EmployeeDocument fetchEmployeeDocument(long documentId) {
		return employeeDocumentPersistence.fetchByPrimaryKey(documentId);
	}
	...
	public EmployeeDocument fetchEmployeeDocumentByUuidAndGroupId(
		...
		return employeeDocumentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EmployeeDocument getEmployeeDocument(long documentId)
		...
		return employeeDocumentPersistence.findByPrimaryKey(documentId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<EmployeeDocument>() {

				@Override
				public void performAction(EmployeeDocument employeeDocument)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeDocument);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EmployeeDocumentLocalServiceImpl#deleteEmployeeDocument(EmployeeDocument) to avoid orphaned data");
		}
	...
	public List<EmployeeDocument> getEmployeeDocumentsByUuidAndCompanyId(
		...
		return employeeDocumentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EmployeeDocument> getEmployeeDocumentsByUuidAndCompanyId(
		...
		return employeeDocumentPersistence.findByUuid_C(
	...
	public EmployeeDocument getEmployeeDocumentByUuidAndGroupId(
		...
		return employeeDocumentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeDocumentLocalServiceBaseImpl.class);
