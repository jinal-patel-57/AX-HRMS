...
import com.ax.hrms.service.EmployeeWishService;
...
/**
 * Provides the base implementation for the employee wish remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeWishServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeWishServiceImpl
 * @generated
 */
public abstract class EmployeeWishServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeWishService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeWishService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeWishServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeWishService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeWishService = (EmployeeWishService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeWishService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeWishLocalService
		employeeWishLocalService;

	protected EmployeeWishService employeeWishService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeWishServiceBaseImpl.class);
