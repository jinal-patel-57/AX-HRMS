...
import com.ax.hrms.model.ProjectTable;
import com.ax.hrms.model.impl.ProjectImpl;
import com.ax.hrms.model.impl.ProjectModelImpl;
import com.ax.hrms.service.persistence.ProjectPersistence;
import com.ax.hrms.service.persistence.ProjectUtil;
...
public class ProjectPersistenceImpl
	...
	/**
	 * Returns the project where projectId = &#63; or throws a <code>NoSuchProjectException</code> if it could not be found.
	 *
	 ...
	 */
	@Override
	public Project fetchByProjectId(long projectId) {
	 ...
	 */
	@Override
	public Project fetchByProjectId(long projectId, boolean useFinderCache) {
		Object[] finderArgs = null;
	...
	public void cacheResult(Project project) {
		...
		finderCache.putResult(
			_finderPathFetchByProjectId, new Object[] {project.getProjectId()},
			project);
	}
	...
	protected void cacheUniqueFindersCache(ProjectModelImpl projectModelImpl) {
		...
		finderCache.putResult(
			_finderPathFetchByProjectId, args, projectModelImpl);
	}
