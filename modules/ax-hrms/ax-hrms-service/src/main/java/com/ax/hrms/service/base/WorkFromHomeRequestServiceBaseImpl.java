...
import com.ax.hrms.service.WorkFromHomeRequestService;
...
/**
 * Provides the base implementation for the work from home request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.WorkFromHomeRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.WorkFromHomeRequestServiceImpl
 * @generated
 */
public abstract class WorkFromHomeRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WorkFromHomeRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkFromHomeRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.WorkFromHomeRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkFromHomeRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		workFromHomeRequestService = (WorkFromHomeRequestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkFromHomeRequestService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.WorkFromHomeRequestLocalService
		workFromHomeRequestLocalService;

	protected WorkFromHomeRequestService workFromHomeRequestService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WorkFromHomeRequestServiceBaseImpl.class);
