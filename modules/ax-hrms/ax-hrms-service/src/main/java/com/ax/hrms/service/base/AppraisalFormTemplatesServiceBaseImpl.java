...
import com.ax.hrms.service.AppraisalFormTemplatesService;
...
/**
 * Provides the base implementation for the appraisal form templates remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalFormTemplatesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalFormTemplatesServiceImpl
 * @generated
 */
public abstract class AppraisalFormTemplatesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalFormTemplatesService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalFormTemplatesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalFormTemplatesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalFormTemplatesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appraisalFormTemplatesService = (AppraisalFormTemplatesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalFormTemplatesService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalFormTemplatesLocalService
		appraisalFormTemplatesLocalService;

	protected AppraisalFormTemplatesService appraisalFormTemplatesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalFormTemplatesServiceBaseImpl.class);
