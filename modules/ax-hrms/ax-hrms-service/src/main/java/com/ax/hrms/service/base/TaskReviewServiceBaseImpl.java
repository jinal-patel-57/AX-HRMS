...
import com.ax.hrms.service.TaskReviewService;
...
/**
 * Provides the base implementation for the task review remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.TaskReviewServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.TaskReviewServiceImpl
 * @generated
 */
public abstract class TaskReviewServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TaskReviewService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TaskReviewService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.TaskReviewServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TaskReviewService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		taskReviewService = (TaskReviewService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaskReviewService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.TaskReviewLocalService taskReviewLocalService;

	protected TaskReviewService taskReviewService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TaskReviewServiceBaseImpl.class);
