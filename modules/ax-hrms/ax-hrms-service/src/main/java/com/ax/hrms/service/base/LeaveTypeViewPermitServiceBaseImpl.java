...
import com.ax.hrms.service.LeaveTypeViewPermitService;
...
/**
 * Provides the base implementation for the leave type view permit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveTypeViewPermitServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveTypeViewPermitServiceImpl
 * @generated
 */
public abstract class LeaveTypeViewPermitServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveTypeViewPermitService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveTypeViewPermitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveTypeViewPermitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveTypeViewPermitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveTypeViewPermitService = (LeaveTypeViewPermitService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveTypeViewPermitService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.LeaveTypeViewPermitLocalService
		leaveTypeViewPermitLocalService;

	protected LeaveTypeViewPermitService leaveTypeViewPermitService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveTypeViewPermitServiceBaseImpl.class);
