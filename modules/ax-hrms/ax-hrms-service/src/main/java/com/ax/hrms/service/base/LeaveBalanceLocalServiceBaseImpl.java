...
/**
 * Provides the base implementation for the leave balance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveBalanceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveBalanceLocalServiceImpl
 * @generated
 */
public abstract class LeaveBalanceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveBalanceLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveBalanceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveBalanceLocalServiceUtil</code>.
	 */
	...
	public LeaveBalance addLeaveBalance(LeaveBalance leaveBalance) {
		...
		return leaveBalancePersistence.update(leaveBalance);
	}
	...
	public LeaveBalance createLeaveBalance(long leaveBalanceId) {
		return leaveBalancePersistence.create(leaveBalanceId);
	}
	...
	public LeaveBalance deleteLeaveBalance(long leaveBalanceId)
		...
		return leaveBalancePersistence.remove(leaveBalanceId);
	}
	...
	public LeaveBalance deleteLeaveBalance(LeaveBalance leaveBalance) {
		return leaveBalancePersistence.remove(leaveBalance);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return leaveBalancePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LeaveBalance.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveBalancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return leaveBalancePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveBalancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return leaveBalancePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LeaveBalance fetchLeaveBalance(long leaveBalanceId) {
		return leaveBalancePersistence.fetchByPrimaryKey(leaveBalanceId);
	}
	...
	public LeaveBalance fetchLeaveBalanceByUuidAndGroupId(
		...
		return leaveBalancePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public LeaveBalance getLeaveBalance(long leaveBalanceId)
		...
		return leaveBalancePersistence.findByPrimaryKey(leaveBalanceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveBalanceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveBalance.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveBalanceId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LeaveBalance.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<LeaveBalance>() {

				@Override
				public void performAction(LeaveBalance leaveBalance)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, leaveBalance);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return leaveBalancePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LeaveBalanceLocalServiceImpl#deleteLeaveBalance(LeaveBalance) to avoid orphaned data");
		}

		return leaveBalanceLocalService.deleteLeaveBalance(
			(LeaveBalance)persistedModel);
	}

	@Override
	public BasePersistence<LeaveBalance> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return leaveBalancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LeaveBalance> getLeaveBalancesByUuidAndCompanyId(
		...
		return leaveBalancePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LeaveBalance> getLeaveBalancesByUuidAndCompanyId(
		...
		return leaveBalancePersistence.findByUuid_C(
	...
	public LeaveBalance getLeaveBalanceByUuidAndGroupId(
		...
		return leaveBalancePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<LeaveBalance> getLeaveBalances(int start, int end) {
		return leaveBalancePersistence.findAll(start, end);
	}
	...
	public int getLeaveBalancesCount() {
		return leaveBalancePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveBalanceLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		leaveBalanceLocalService = (LeaveBalanceLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveBalanceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = leaveBalancePersistence.getDataSource();
	...
	protected LeaveBalanceLocalService leaveBalanceLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveBalanceLocalServiceBaseImpl.class);
