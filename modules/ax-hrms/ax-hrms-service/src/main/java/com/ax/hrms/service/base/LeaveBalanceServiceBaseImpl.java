...
import com.ax.hrms.service.LeaveBalanceService;
...
/**
 * Provides the base implementation for the leave balance remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveBalanceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveBalanceServiceImpl
 * @generated
 */
public abstract class LeaveBalanceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveBalanceService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveBalanceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveBalanceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveBalanceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveBalanceService = (LeaveBalanceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveBalanceService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.LeaveBalanceLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveBalanceServiceBaseImpl.class);
