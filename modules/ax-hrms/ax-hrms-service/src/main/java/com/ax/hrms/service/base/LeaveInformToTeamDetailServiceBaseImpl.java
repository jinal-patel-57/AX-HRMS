...
import com.ax.hrms.service.LeaveInformToTeamDetailService;
...
/**
 * Provides the base implementation for the leave inform to team detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveInformToTeamDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveInformToTeamDetailServiceImpl
 * @generated
 */
public abstract class LeaveInformToTeamDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LeaveInformToTeamDetailService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveInformToTeamDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveInformToTeamDetailServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveInformToTeamDetailService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		leaveInformToTeamDetailService =
			(LeaveInformToTeamDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveInformToTeamDetailService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.LeaveInformToTeamDetailLocalService
		leaveInformToTeamDetailLocalService;

	protected LeaveInformToTeamDetailService leaveInformToTeamDetailService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveInformToTeamDetailServiceBaseImpl.class);
