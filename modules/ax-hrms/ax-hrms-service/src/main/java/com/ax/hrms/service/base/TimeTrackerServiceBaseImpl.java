...
import com.ax.hrms.service.TimeTrackerService;
...
/**
 * Provides the base implementation for the time tracker remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.TimeTrackerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.TimeTrackerServiceImpl
 * @generated
 */
public abstract class TimeTrackerServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TimeTrackerService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TimeTrackerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.TimeTrackerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TimeTrackerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		timeTrackerService = (TimeTrackerService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimeTrackerService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.TimeTrackerLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TimeTrackerServiceBaseImpl.class);
