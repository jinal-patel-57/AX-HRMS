...
import com.ax.hrms.service.PolicyService;
...
/**
 * Provides the base implementation for the policy remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.PolicyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.PolicyServiceImpl
 * @generated
 */
public abstract class PolicyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PolicyService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PolicyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.PolicyServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PolicyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		policyService = (PolicyService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PolicyService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.PolicyLocalService policyLocalService;
