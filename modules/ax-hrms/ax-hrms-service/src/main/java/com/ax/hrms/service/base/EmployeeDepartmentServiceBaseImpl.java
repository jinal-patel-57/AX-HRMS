...
import com.ax.hrms.service.EmployeeDepartmentService;
...
/**
 * Provides the base implementation for the employee department remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeDepartmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeDepartmentServiceImpl
 * @generated
 */
public abstract class EmployeeDepartmentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeDepartmentService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDepartmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeDepartmentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDepartmentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeDepartmentService = (EmployeeDepartmentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDepartmentService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeDepartmentLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeDepartmentServiceBaseImpl.class);
