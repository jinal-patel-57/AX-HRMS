...
import com.ax.hrms.service.EmployeeSalaryService;
...
/**
 * Provides the base implementation for the employee salary remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeSalaryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeSalaryServiceImpl
 * @generated
 */
public abstract class EmployeeSalaryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeSalaryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeSalaryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeSalaryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeSalaryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeSalaryService = (EmployeeSalaryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeSalaryService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeSalaryLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeSalaryServiceBaseImpl.class);
