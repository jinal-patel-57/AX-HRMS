 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AttachmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AttachmentLocalServiceImpl
 * @generated
 */
public abstract class AttachmentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttachmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AttachmentLocalServiceUtil</code>.
	 */
	 ...
	 */
	@Override
	public Attachment fetchAttachmentByUuidAndGroupId(
		String uuid, long groupId) {

		return attachmentPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<Attachment> getAttachmentsByUuidAndCompanyId(
		String uuid, long companyId) {

		return attachmentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Attachment> getAttachmentsByUuidAndCompanyId(
		...
		return attachmentPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public Attachment getAttachmentByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return attachmentPersistence.findByUUID_G(uuid, groupId);
	}
