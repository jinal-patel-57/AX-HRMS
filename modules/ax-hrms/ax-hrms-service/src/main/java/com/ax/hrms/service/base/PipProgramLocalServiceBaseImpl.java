...
/**
 * Provides the base implementation for the pip program local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.PipProgramLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.PipProgramLocalServiceImpl
 * @generated
 */
public abstract class PipProgramLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PipProgramLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PipProgramLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.PipProgramLocalServiceUtil</code>.
	 */
	...
	@Override
	public PipProgram addPipProgram(PipProgram pipProgram) {
		pipProgram.setNew(true);

		return pipProgramPersistence.update(pipProgram);
	}
	...
	public PipProgram createPipProgram(long pipProgramId) {
		return pipProgramPersistence.create(pipProgramId);
	}
	...
	@Override
	public PipProgram deletePipProgram(long pipProgramId)
		throws PortalException {

		return pipProgramPersistence.remove(pipProgramId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PipProgram deletePipProgram(PipProgram pipProgram) {
		return pipProgramPersistence.remove(pipProgram);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return pipProgramPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PipProgram.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pipProgramPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return pipProgramPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pipProgramPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return pipProgramPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PipProgram fetchPipProgram(long pipProgramId) {
		return pipProgramPersistence.fetchByPrimaryKey(pipProgramId);
	}
	 ...
	 */
	@Override
	public PipProgram fetchPipProgramByUuidAndGroupId(
		String uuid, long groupId) {

		return pipProgramPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public PipProgram getPipProgram(long pipProgramId) throws PortalException {
		return pipProgramPersistence.findByPrimaryKey(pipProgramId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(pipProgramLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PipProgram.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("pipProgramId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			pipProgramLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PipProgram.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<PipProgram>() {

				@Override
				public void performAction(PipProgram pipProgram)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, pipProgram);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return pipProgramPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PipProgramLocalServiceImpl#deletePipProgram(PipProgram) to avoid orphaned data");
		}

		return pipProgramLocalService.deletePipProgram(
			(PipProgram)persistedModel);
	}

	@Override
	public BasePersistence<PipProgram> getBasePersistence() {
		return pipProgramPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return pipProgramPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PipProgram> getPipProgramsByUuidAndCompanyId(
		String uuid, long companyId) {

		return pipProgramPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<PipProgram> getPipProgramsByUuidAndCompanyId(
		...
		return pipProgramPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public PipProgram getPipProgramByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return pipProgramPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<PipProgram> getPipPrograms(int start, int end) {
		return pipProgramPersistence.findAll(start, end);
	}
	...
	public int getPipProgramsCount() {
		return pipProgramPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PipProgram updatePipProgram(PipProgram pipProgram) {
		return pipProgramPersistence.update(pipProgram);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PipProgramLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		pipProgramLocalService = (PipProgramLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PipProgramLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = pipProgramPersistence.getDataSource();
	...
	protected PipProgramLocalService pipProgramLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PipProgramLocalServiceBaseImpl.class);
