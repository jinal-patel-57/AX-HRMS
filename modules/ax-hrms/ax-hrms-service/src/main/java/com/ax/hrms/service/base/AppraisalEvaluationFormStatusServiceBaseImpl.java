...
import com.ax.hrms.service.AppraisalEvaluationFormStatusService;
...
/**
 * Provides the base implementation for the appraisal evaluation form status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalEvaluationFormStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalEvaluationFormStatusServiceImpl
 * @generated
 */
public abstract class AppraisalEvaluationFormStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalEvaluationFormStatusService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalEvaluationFormStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalEvaluationFormStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		appraisalEvaluationFormStatusService =
			(AppraisalEvaluationFormStatusService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalEvaluationFormStatusService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalEvaluationFormStatusLocalService
		appraisalEvaluationFormStatusLocalService;

	protected AppraisalEvaluationFormStatusService
		appraisalEvaluationFormStatusService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalEvaluationFormStatusServiceBaseImpl.class);
