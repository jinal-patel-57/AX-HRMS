...
import com.ax.hrms.model.AddressModel;
...
/**
 * The base model implementation for the Address service. Represents a row in the &quot;ax_Address&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AddressModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "ax_Address";
	...
	public static final String ORDER_BY_SQL =
		" ORDER BY ax_Address.addressId ASC";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("createdBy", Address::getCreatedBy);
			attributeGetterFunctions.put("modifiedBy", Address::getModifiedBy);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"createdBy", (BiConsumer<Address, Long>)Address::setCreatedBy);
			attributeSetterBiConsumers.put(
				"modifiedBy",
				(BiConsumer<Address, Long>)Address::setModifiedBy);
			attributeSetterBiConsumers.put(
			...
			attributeSetterBiConsumers.put(
				"line1", (BiConsumer<Address, String>)Address::setLine1);
			attributeSetterBiConsumers.put(
			...
			attributeSetterBiConsumers.put(
				"country", (BiConsumer<Address, Long>)Address::setCountry);
			attributeSetterBiConsumers.put(
	...
	public Object clone() {
		...
		addressImpl.setCreatedBy(getCreatedBy());
		addressImpl.setModifiedBy(getModifiedBy());
	...
	public Address cloneWithOriginalValues() {
		...
		addressImpl.setCompanyId(
			this.<Long>getColumnOriginalValue("companyId"));
		addressImpl.setCreatedBy(
			this.<Long>getColumnOriginalValue("createdBy"));
		addressImpl.setModifiedBy(
	...
	public CacheModel<Address> toCacheModel() {
		...
		addressCacheModel.createdBy = getCreatedBy();

		addressCacheModel.modifiedBy = getModifiedBy();
		...
		addressCacheModel.line1 = getLine1();

		String line1 = addressCacheModel.line1;

		if ((line1 != null) && (line1.length() == 0)) {
			addressCacheModel.line1 = null;
		}

		addressCacheModel.line2 = getLine2();

		String line2 = addressCacheModel.line2;

		if ((line2 != null) && (line2.length() == 0)) {
			addressCacheModel.line2 = null;
		}

		addressCacheModel.line3 = getLine3();

		String line3 = addressCacheModel.line3;
	...
	static {
		...
		columnBitmasks.put("addressId", 128L);

		columnBitmasks.put("line1", 256L);

		columnBitmasks.put("line2", 512L);
