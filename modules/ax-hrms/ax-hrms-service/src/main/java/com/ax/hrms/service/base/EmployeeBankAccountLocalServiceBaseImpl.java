...
/**
 * Provides the base implementation for the employee bank account local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeBankAccountLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeBankAccountLocalServiceImpl
 * @generated
 */
public abstract class EmployeeBankAccountLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeBankAccountLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeBankAccountLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeBankAccountLocalServiceUtil</code>.
	 */
	...
	public EmployeeBankAccount addEmployeeBankAccount(
		...
		return employeeBankAccountPersistence.update(employeeBankAccount);
	}
	...
	public EmployeeBankAccount createEmployeeBankAccount(long bankAccountId) {
		return employeeBankAccountPersistence.create(bankAccountId);
	}
	...
	@Override
	public EmployeeBankAccount deleteEmployeeBankAccount(long bankAccountId)
		throws PortalException {

		return employeeBankAccountPersistence.remove(bankAccountId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeBankAccount deleteEmployeeBankAccount(
		EmployeeBankAccount employeeBankAccount) {

		return employeeBankAccountPersistence.remove(employeeBankAccount);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return employeeBankAccountPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeBankAccount.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeBankAccountPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeBankAccountPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public EmployeeBankAccount fetchEmployeeBankAccount(long bankAccountId) {
		return employeeBankAccountPersistence.fetchByPrimaryKey(bankAccountId);
	}
	 ...
	 */
	@Override
	public EmployeeBankAccount fetchEmployeeBankAccountByUuidAndGroupId(
		String uuid, long groupId) {

		return employeeBankAccountPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public EmployeeBankAccount getEmployeeBankAccount(long bankAccountId)
		throws PortalException {

		return employeeBankAccountPersistence.findByPrimaryKey(bankAccountId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			employeeBankAccountLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeBankAccount.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("bankAccountId");
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeBankAccount);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					EmployeeBankAccount.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeBankAccountPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EmployeeBankAccountLocalServiceImpl#deleteEmployeeBankAccount(EmployeeBankAccount) to avoid orphaned data");
		}

		return employeeBankAccountLocalService.deleteEmployeeBankAccount(
			(EmployeeBankAccount)persistedModel);
	}

	@Override
	public BasePersistence<EmployeeBankAccount> getBasePersistence() {
		return employeeBankAccountPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeBankAccountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeBankAccount> getEmployeeBankAccountsByUuidAndCompanyId(
		String uuid, long companyId) {

		return employeeBankAccountPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EmployeeBankAccount> getEmployeeBankAccountsByUuidAndCompanyId(
		...
		return employeeBankAccountPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public EmployeeBankAccount getEmployeeBankAccountByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return employeeBankAccountPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EmployeeBankAccount> getEmployeeBankAccounts(
		...
		return employeeBankAccountPersistence.findAll(start, end);
	}
	...
	public int getEmployeeBankAccountsCount() {
		return employeeBankAccountPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeBankAccount updateEmployeeBankAccount(
		EmployeeBankAccount employeeBankAccount) {
	...
	public void setAopProxy(Object aopProxy) {
		employeeBankAccountLocalService =
			(EmployeeBankAccountLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeBankAccountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = employeeBankAccountPersistence.getDataSource();
	...
	protected EmployeeBankAccountLocalService employeeBankAccountLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeBankAccountLocalServiceBaseImpl.class);
