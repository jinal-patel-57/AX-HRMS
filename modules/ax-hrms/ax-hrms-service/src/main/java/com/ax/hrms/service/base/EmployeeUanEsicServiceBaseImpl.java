...
import com.ax.hrms.service.EmployeeUanEsicService;
...
/**
 * Provides the base implementation for the employee uan esic remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeUanEsicServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeUanEsicServiceImpl
 * @generated
 */
public abstract class EmployeeUanEsicServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeUanEsicService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeUanEsicService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeUanEsicServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeUanEsicService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeUanEsicService = (EmployeeUanEsicService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeUanEsicService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeUanEsicLocalService
		employeeUanEsicLocalService;

	protected EmployeeUanEsicService employeeUanEsicService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeUanEsicServiceBaseImpl.class);
