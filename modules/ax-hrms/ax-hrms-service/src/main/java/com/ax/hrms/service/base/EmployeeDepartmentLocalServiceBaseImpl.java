...
/**
 * Provides the base implementation for the employee department local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeDepartmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeDepartmentLocalServiceImpl
 * @generated
 */
public abstract class EmployeeDepartmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeDepartmentLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDepartmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeDepartmentLocalServiceUtil</code>.
	 */
	...
	public EmployeeDepartment addEmployeeDepartment(
		...
		return employeeDepartmentPersistence.update(employeeDepartment);
	}
	...
	public EmployeeDepartment createEmployeeDepartment(
		...
		return employeeDepartmentPersistence.create(employeeDepartmentId);
	}
	...
	public EmployeeDepartment deleteEmployeeDepartment(
		...
		return employeeDepartmentPersistence.remove(employeeDepartmentId);
	}
	...
	public EmployeeDepartment deleteEmployeeDepartment(
		...
		return employeeDepartmentPersistence.remove(employeeDepartment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return employeeDepartmentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeDepartment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeDepartmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeDepartmentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeDepartmentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EmployeeDepartment fetchEmployeeDepartment(
		...
		return employeeDepartmentPersistence.fetchByPrimaryKey(
	...
	public EmployeeDepartment fetchEmployeeDepartmentByUuidAndGroupId(
		...
		return employeeDepartmentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EmployeeDepartment getEmployeeDepartment(long employeeDepartmentId)
		...
		return employeeDepartmentPersistence.findByPrimaryKey(
			employeeDepartmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EmployeeDepartment.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeDepartment.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(EmployeeDepartment employeeDepartment)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeDepartment);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDepartmentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EmployeeDepartmentLocalServiceImpl#deleteEmployeeDepartment(EmployeeDepartment) to avoid orphaned data");
		}

		return employeeDepartmentLocalService.deleteEmployeeDepartment(
			(EmployeeDepartment)persistedModel);
	}

	@Override
	public BasePersistence<EmployeeDepartment> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeDepartmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EmployeeDepartment> getEmployeeDepartmentsByUuidAndCompanyId(
		...
		return employeeDepartmentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EmployeeDepartment> getEmployeeDepartmentsByUuidAndCompanyId(
		...
		return employeeDepartmentPersistence.findByUuid_C(
	...
	public EmployeeDepartment getEmployeeDepartmentByUuidAndGroupId(
		...
		return employeeDepartmentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EmployeeDepartment> getEmployeeDepartments(int start, int end) {
		return employeeDepartmentPersistence.findAll(start, end);
	}
	...
	public int getEmployeeDepartmentsCount() {
		return employeeDepartmentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDepartmentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeDepartmentLocalService =
			(EmployeeDepartmentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDepartmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = employeeDepartmentPersistence.getDataSource();
	...
	protected EmployeeDepartmentLocalService employeeDepartmentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeDepartmentLocalServiceBaseImpl.class);
