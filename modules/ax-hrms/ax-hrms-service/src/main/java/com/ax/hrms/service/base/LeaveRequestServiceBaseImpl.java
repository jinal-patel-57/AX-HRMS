...
import com.ax.hrms.service.LeaveRequestService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveRequestServiceImpl
 * @generated
 */
public abstract class LeaveRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveRequestService = (LeaveRequestService)aopProxy;
	}
	...
	@Reference
	protected com.ax.hrms.service.LeaveRequestLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveRequestServiceBaseImpl.class);
