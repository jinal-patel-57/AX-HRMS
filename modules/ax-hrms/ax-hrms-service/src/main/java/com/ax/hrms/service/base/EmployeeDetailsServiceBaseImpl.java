...
import com.ax.hrms.service.EmployeeDetailsService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeDetailsServiceImpl
 * @generated
 */
public abstract class EmployeeDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeDetailsService = (EmployeeDetailsService)aopProxy;
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeDetailsLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeDetailsServiceBaseImpl.class);
