...
import com.ax.hrms.service.AppraisalMeetingService;
...
/**
 * Provides the base implementation for the appraisal meeting remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalMeetingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalMeetingServiceImpl
 * @generated
 */
public abstract class AppraisalMeetingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalMeetingService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalMeetingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalMeetingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalMeetingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appraisalMeetingService = (AppraisalMeetingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalMeetingService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalMeetingLocalService
		appraisalMeetingLocalService;

	protected AppraisalMeetingService appraisalMeetingService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalMeetingServiceBaseImpl.class);
