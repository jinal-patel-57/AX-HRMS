...
public class LeaveRequestPersistenceImpl
	...
	public List<LeaveRequest> findByEmployeeIdAndStatus(
		...
		return findByEmployeeIdAndStatus(
			employeeId, leaveCompensatoryStatusMasterId, QueryUtil.ALL_POS,
	...
	public List<LeaveRequest> findByEmployeeIdAndStatus(
		...
		return findByEmployeeIdAndStatus(
			employeeId, leaveCompensatoryStatusMasterId, start, end, null);
	}
	...
	public List<LeaveRequest> findByEmployeeIdAndStatus(
		...
		if (list == null) {
			...
			sb.append(
				_FINDER_COLUMN_EMPLOYEEIDANDSTATUS_LEAVECOMPENSATORYSTATUSMASTERID_2);
	 ...
	 */
	@Override
	public LeaveRequest findByEmployeeIdAndStatus_First(
			long employeeId, long leaveCompensatoryStatusMasterId,
			OrderByComparator<LeaveRequest> orderByComparator)
		throws NoSuchLeaveRequestException {

		LeaveRequest leaveRequest = fetchByEmployeeIdAndStatus_First(
	 ...
	 */
	@Override
	public LeaveRequest fetchByEmployeeIdAndStatus_First(
		long employeeId, long leaveCompensatoryStatusMasterId,
		OrderByComparator<LeaveRequest> orderByComparator) {

		List<LeaveRequest> list = findByEmployeeIdAndStatus(
			employeeId, leaveCompensatoryStatusMasterId, 0, 1,
			orderByComparator);
	 ...
	 */
	@Override
	public LeaveRequest findByEmployeeIdAndStatus_Last(
			long employeeId, long leaveCompensatoryStatusMasterId,
			OrderByComparator<LeaveRequest> orderByComparator)
		throws NoSuchLeaveRequestException {

		LeaveRequest leaveRequest = fetchByEmployeeIdAndStatus_Last(
			employeeId, leaveCompensatoryStatusMasterId, orderByComparator);
	 ...
	 */
	@Override
	public LeaveRequest fetchByEmployeeIdAndStatus_Last(
		long employeeId, long leaveCompensatoryStatusMasterId,
		OrderByComparator<LeaveRequest> orderByComparator) {

		int count = countByEmployeeIdAndStatus(
			employeeId, leaveCompensatoryStatusMasterId);
		...
		List<LeaveRequest> list = findByEmployeeIdAndStatus(
			employeeId, leaveCompensatoryStatusMasterId, count - 1, count,
			orderByComparator);
	 ...
	 */
	@Override
	public LeaveRequest[] findByEmployeeIdAndStatus_PrevAndNext(
			long leaveRequestId, long employeeId,
		...
		try {
			...
			array[0] = getByEmployeeIdAndStatus_PrevAndNext(
				session, leaveRequest, employeeId,
				leaveCompensatoryStatusMasterId, orderByComparator, true);

			array[1] = leaveRequest;

			array[2] = getByEmployeeIdAndStatus_PrevAndNext(
				session, leaveRequest, employeeId,
				leaveCompensatoryStatusMasterId, orderByComparator, false);
	...
	protected LeaveRequest getByEmployeeIdAndStatus_PrevAndNext(
		Session session, LeaveRequest leaveRequest, long employeeId,
		long leaveCompensatoryStatusMasterId,
		OrderByComparator<LeaveRequest> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByEmployeeIdAndStatus(
		long employeeId, long leaveCompensatoryStatusMasterId) {
	 ...
	 */
	@Override
	public int countByEmployeeIdAndStatus(
		long employeeId, long leaveCompensatoryStatusMasterId) {
	...
	private static final String
		_FINDER_COLUMN_EMPLOYEEIDANDSTATUS_LEAVECOMPENSATORYSTATUSMASTERID_2 =
			"leaveRequest.leaveCompensatoryStatusMasterId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByEmployeeIdAndStatus = new FinderPath(
			...
			new String[] {"employeeId", "leaveCompensatoryStatusMasterId"},
			true);
