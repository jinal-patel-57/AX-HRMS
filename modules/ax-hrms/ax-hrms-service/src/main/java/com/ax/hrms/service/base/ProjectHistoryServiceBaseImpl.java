...
import com.ax.hrms.service.ProjectHistoryService;
...
/**
 * Provides the base implementation for the project history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.ProjectHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.ProjectHistoryServiceImpl
 * @generated
 */
public abstract class ProjectHistoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProjectHistoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProjectHistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.ProjectHistoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProjectHistoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		projectHistoryService = (ProjectHistoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectHistoryService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.ProjectHistoryLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProjectHistoryServiceBaseImpl.class);
