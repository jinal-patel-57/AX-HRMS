...
import com.ax.hrms.model.EmployeeDesignationTable;
import com.ax.hrms.model.impl.EmployeeDesignationImpl;
import com.ax.hrms.model.impl.EmployeeDesignationModelImpl;
import com.ax.hrms.service.persistence.EmployeeDesignationPersistence;
import com.ax.hrms.service.persistence.EmployeeDesignationUtil;
...
public class EmployeeDesignationPersistenceImpl
	 ...
	 */
	@Override
	public List<EmployeeDesignation> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<EmployeeDesignation> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (EmployeeDesignation employeeDesignation : list) {
					if (!uuid.equals(employeeDesignation.getUuid())) {
						list = null;
	...
	public EmployeeDesignation findByUuid_First(
		...
		EmployeeDesignation employeeDesignation = fetchByUuid_First(
	...
	public EmployeeDesignation fetchByUuid_First(
		...
		List<EmployeeDesignation> list = findByUuid(
	...
	public EmployeeDesignation findByUuid_Last(
		...
		EmployeeDesignation employeeDesignation = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public EmployeeDesignation[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, employeeDesignation, uuid, orderByComparator, true);

			array[1] = employeeDesignation;

			array[2] = getByUuid_PrevAndNext(
				session, employeeDesignation, uuid, orderByComparator, false);
	...
	protected EmployeeDesignation getByUuid_PrevAndNext(
		Session session, EmployeeDesignation employeeDesignation, String uuid,
		OrderByComparator<EmployeeDesignation> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"employeeDesignation.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(employeeDesignation.uuid IS NULL OR employeeDesignation.uuid = '')";
	...
	public EmployeeDesignation findByUUID_G(String uuid, long groupId)
		...
		EmployeeDesignation employeeDesignation = fetchByUUID_G(uuid, groupId);
	...
	public EmployeeDesignation fetchByUUID_G(
		...
		if (result instanceof EmployeeDesignation) {
			...
			if (!Objects.equals(uuid, employeeDesignation.getUuid()) ||
	...
	public EmployeeDesignation removeByUUID_G(String uuid, long groupId)
		...
		EmployeeDesignation employeeDesignation = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"employeeDesignation.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(employeeDesignation.uuid IS NULL OR employeeDesignation.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"employeeDesignation.groupId = ?";
	 ...
	 */
	@Override
	public List<EmployeeDesignation> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<EmployeeDesignation> findByUuid_C(
	...
	public EmployeeDesignation findByUuid_C_First(
		...
		EmployeeDesignation employeeDesignation = fetchByUuid_C_First(
	...
	public EmployeeDesignation fetchByUuid_C_First(
		...
		List<EmployeeDesignation> list = findByUuid_C(
	...
	public EmployeeDesignation findByUuid_C_Last(
		...
		EmployeeDesignation employeeDesignation = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public EmployeeDesignation[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, employeeDesignation, uuid, companyId,
	...
	protected EmployeeDesignation getByUuid_C_PrevAndNext(
		Session session, EmployeeDesignation employeeDesignation, String uuid,
		long companyId,
		OrderByComparator<EmployeeDesignation> orderByComparator,
		boolean previous) {
	...
	public EmployeeDesignation findByEmployeeId(long employeeId)
		...
		EmployeeDesignation employeeDesignation = fetchByEmployeeId(employeeId);
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"EmployeeDesignationPersistenceImpl.fetchByEmployeeId(long, boolean) with parameters (" +
	...
	public EmployeeDesignation removeByEmployeeId(long employeeId)
		...
		EmployeeDesignation employeeDesignation = findByEmployeeId(employeeId);
	...
	public EmployeeDesignationPersistenceImpl() {
		...
		setTable(EmployeeDesignationTable.INSTANCE);
	}
	...
	public void cacheResult(EmployeeDesignation employeeDesignation) {
		...
		finderCache.putResult(
			...
			new Object[] {
				employeeDesignation.getUuid(), employeeDesignation.getGroupId()
			},
			employeeDesignation);
	...
	public void clearCache() {
		...
		finderCache.clearCache(EmployeeDesignationImpl.class);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			employeeDesignationModelImpl.getUuid(),
			employeeDesignationModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, employeeDesignationModelImpl);

		args = new Object[] {employeeDesignationModelImpl.getEmployeeId()};
	...
	public EmployeeDesignation create(long employeeDesignationId) {
		...
		employeeDesignation.setUuid(uuid);
	...
	public EmployeeDesignation updateImpl(
		...
		if (Validator.isNull(employeeDesignation.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (employeeDesignation.getCreateDate() == null)) {
			if (serviceContext == null) {
				employeeDesignation.setCreateDate(date);
			}
			else {
		...
		if (!employeeDesignationModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				employeeDesignation.setModifiedDate(date);
			}
			else {
		...
		cacheUniqueFindersCache(employeeDesignationModelImpl);
	...
	public void deactivate() {
		EmployeeDesignationUtil.setPersistence(null);
