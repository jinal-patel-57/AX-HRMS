...
import com.ax.hrms.service.ProjectEmployeeDetailsService;
...
/**
 * Provides the base implementation for the project employee details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.ProjectEmployeeDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.ProjectEmployeeDetailsServiceImpl
 * @generated
 */
public abstract class ProjectEmployeeDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProjectEmployeeDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProjectEmployeeDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.ProjectEmployeeDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProjectEmployeeDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		projectEmployeeDetailsService = (ProjectEmployeeDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectEmployeeDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.ProjectEmployeeDetailsLocalService
		projectEmployeeDetailsLocalService;

	protected ProjectEmployeeDetailsService projectEmployeeDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProjectEmployeeDetailsServiceBaseImpl.class);
