...
import com.ax.hrms.service.LeaveDayTypeService;
...
/**
 * Provides the base implementation for the leave day type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveDayTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveDayTypeServiceImpl
 * @generated
 */
public abstract class LeaveDayTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveDayTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveDayTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveDayTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveDayTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveDayTypeService = (LeaveDayTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveDayTypeService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.LeaveDayTypeLocalService
		leaveDayTypeLocalService;

	protected LeaveDayTypeService leaveDayTypeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveDayTypeServiceBaseImpl.class);
