...
import com.ax.hrms.service.PipProgramService;
...
/**
 * Provides the base implementation for the pip program remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.PipProgramServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.PipProgramServiceImpl
 * @generated
 */
public abstract class PipProgramServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PipProgramService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PipProgramService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.PipProgramServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PipProgramService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		pipProgramService = (PipProgramService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PipProgramService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.PipProgramLocalService pipProgramLocalService;

	protected PipProgramService pipProgramService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PipProgramServiceBaseImpl.class);
