...
import com.ax.hrms.service.persistence.EmployeeExperienceUtil;
...
public class EmployeeExperiencePersistenceImpl
	 ...
	 */
	@Override
	public List<EmployeeExperience> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<EmployeeExperience> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (EmployeeExperience employeeExperience : list) {
					if (!uuid.equals(employeeExperience.getUuid())) {
						list = null;
	...
	public EmployeeExperience findByUuid_First(
		...
		EmployeeExperience employeeExperience = fetchByUuid_First(
	...
	public EmployeeExperience fetchByUuid_First(
		...
		List<EmployeeExperience> list = findByUuid(
	...
	public EmployeeExperience findByUuid_Last(
		...
		EmployeeExperience employeeExperience = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public EmployeeExperience[] findByUuid_PrevAndNext(
		...
		EmployeeExperience employeeExperience = findByPrimaryKey(experienceId);
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, employeeExperience, uuid, orderByComparator, true);

			array[1] = employeeExperience;

			array[2] = getByUuid_PrevAndNext(
				session, employeeExperience, uuid, orderByComparator, false);
	...
	protected EmployeeExperience getByUuid_PrevAndNext(
		Session session, EmployeeExperience employeeExperience, String uuid,
		OrderByComparator<EmployeeExperience> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"employeeExperience.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(employeeExperience.uuid IS NULL OR employeeExperience.uuid = '')";
	...
	public EmployeeExperience findByUUID_G(String uuid, long groupId)
		...
		EmployeeExperience employeeExperience = fetchByUUID_G(uuid, groupId);
	...
	public EmployeeExperience fetchByUUID_G(
		...
		if (result instanceof EmployeeExperience) {
			EmployeeExperience employeeExperience = (EmployeeExperience)result;

			if (!Objects.equals(uuid, employeeExperience.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					EmployeeExperience employeeExperience = list.get(0);

					result = employeeExperience;
		...
		if (result instanceof List<?>) {
			...
			return (EmployeeExperience)result;
		}
	}
	...
	public EmployeeExperience removeByUUID_G(String uuid, long groupId)
		...
		EmployeeExperience employeeExperience = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"employeeExperience.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(employeeExperience.uuid IS NULL OR employeeExperience.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"employeeExperience.groupId = ?";
	 ...
	 */
	@Override
	public List<EmployeeExperience> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<EmployeeExperience> findByUuid_C(
	...
	public EmployeeExperience findByUuid_C_First(
		...
		EmployeeExperience employeeExperience = fetchByUuid_C_First(
	...
	public EmployeeExperience fetchByUuid_C_First(
		...
		List<EmployeeExperience> list = findByUuid_C(
	...
	public EmployeeExperience findByUuid_C_Last(
		...
		EmployeeExperience employeeExperience = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public EmployeeExperience[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, employeeExperience, uuid, companyId, orderByComparator,
				true);
	...
	protected EmployeeExperience getByUuid_C_PrevAndNext(
		Session session, EmployeeExperience employeeExperience, String uuid,
		long companyId, OrderByComparator<EmployeeExperience> orderByComparator,
		boolean previous) {
	...
	public EmployeeExperiencePersistenceImpl() {
		...
		setTable(EmployeeExperienceTable.INSTANCE);
	}
	...
	public void cacheResult(EmployeeExperience employeeExperience) {
		...
		finderCache.putResult(
			...
			new Object[] {
				employeeExperience.getUuid(), employeeExperience.getGroupId()
			},
			employeeExperience);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(EmployeeExperienceImpl.class);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			employeeExperienceModelImpl.getUuid(),
			employeeExperienceModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathFetchByUUID_G, args, employeeExperienceModelImpl);
	}
	...
	public EmployeeExperience create(long experienceId) {
		...
		employeeExperience.setPrimaryKey(experienceId);

		String uuid = PortalUUIDUtil.generate();

		employeeExperience.setUuid(uuid);
	...
	public EmployeeExperience updateImpl(
		...
		if (Validator.isNull(employeeExperience.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (employeeExperience.getCreateDate() == null)) {
			if (serviceContext == null) {
				employeeExperience.setCreateDate(date);
			}
			else {
		...
		if (!employeeExperienceModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				employeeExperience.setModifiedDate(date);
			}
			else {
		...
		cacheUniqueFindersCache(employeeExperienceModelImpl);
	...
	public void activate() {
		...
		EmployeeExperienceUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		EmployeeExperienceUtil.setPersistence(null);
