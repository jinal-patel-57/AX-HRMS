...
import com.ax.hrms.service.NomineeService;
...
/**
 * Provides the base implementation for the nominee remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.NomineeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.NomineeServiceImpl
 * @generated
 */
public abstract class NomineeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NomineeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NomineeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.NomineeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NomineeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		nomineeService = (NomineeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NomineeService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.NomineeLocalService nomineeLocalService;
