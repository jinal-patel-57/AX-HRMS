...
import com.ax.hrms.service.EmployeeBankAccountService;
...
/**
 * Provides the base implementation for the employee bank account remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeBankAccountServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeBankAccountServiceImpl
 * @generated
 */
public abstract class EmployeeBankAccountServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeBankAccountService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeBankAccountService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeBankAccountServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeBankAccountService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeBankAccountService = (EmployeeBankAccountService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeBankAccountService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeBankAccountLocalService
		employeeBankAccountLocalService;

	protected EmployeeBankAccountService employeeBankAccountService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeBankAccountServiceBaseImpl.class);
