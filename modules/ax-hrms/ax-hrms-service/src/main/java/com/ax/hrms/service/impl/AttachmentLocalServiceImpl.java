...
import com.ax.hrms.service.base.AttachmentLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.ax.hrms.model.Attachment",
...
public class AttachmentLocalServiceImpl extends AttachmentLocalServiceBaseImpl {
	...
	public List<Attachment> findByTimeTrackerId(long timeTrackerId) {
		return attachmentPersistence.findByTimeTrackerId(timeTrackerId);
	}
