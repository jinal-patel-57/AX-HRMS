...
import com.ax.hrms.service.LeaveBalanceHistoryService;
...
/**
 * Provides the base implementation for the leave balance history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.LeaveBalanceHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.LeaveBalanceHistoryServiceImpl
 * @generated
 */
public abstract class LeaveBalanceHistoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveBalanceHistoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveBalanceHistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.LeaveBalanceHistoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveBalanceHistoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveBalanceHistoryService = (LeaveBalanceHistoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveBalanceHistoryService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.LeaveBalanceHistoryLocalService
		leaveBalanceHistoryLocalService;

	protected LeaveBalanceHistoryService leaveBalanceHistoryService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveBalanceHistoryServiceBaseImpl.class);
