...
import com.ax.hrms.service.EmployeeEducationService;
...
/**
 * Provides the base implementation for the employee education remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeEducationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeEducationServiceImpl
 * @generated
 */
public abstract class EmployeeEducationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmployeeEducationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeEducationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeEducationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeEducationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		employeeEducationService = (EmployeeEducationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeEducationService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.EmployeeEducationLocalService
		employeeEducationLocalService;

	protected EmployeeEducationService employeeEducationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeEducationServiceBaseImpl.class);
