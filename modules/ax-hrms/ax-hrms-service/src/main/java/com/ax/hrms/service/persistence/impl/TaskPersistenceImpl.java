...
import com.ax.hrms.model.TaskTable;
import com.ax.hrms.model.impl.TaskImpl;
import com.ax.hrms.model.impl.TaskModelImpl;
import com.ax.hrms.service.persistence.TaskPersistence;
import com.ax.hrms.service.persistence.TaskUtil;
...
public class TaskPersistenceImpl
	...
	public Task fetchByProjectId_Last(
		...
		List<Task> list = findByProjectId(
	...
	public Task[] findByProjectId_PrevAndNext(
		...
		try {
			...
			array[0] = getByProjectId_PrevAndNext(
				session, task, projectId, orderByComparator, true);

			array[1] = task;

			array[2] = getByProjectId_PrevAndNext(
				session, task, projectId, orderByComparator, false);
	...
	protected Task getByProjectId_PrevAndNext(
		Session session, Task task, long projectId,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Task> findByManagerId(long managerId, int start, int end) {
	 ...
	 */
	@Override
	public List<Task> findByManagerId(
	...
	public List<Task> findByManagerId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Task task : list) {
					if (managerId != task.getManagerId()) {
						list = null;
	...
	public Task findByManagerId_First(
		...
		Task task = fetchByManagerId_First(managerId, orderByComparator);
	...
	public Task fetchByManagerId_First(
		...
		List<Task> list = findByManagerId(managerId, 0, 1, orderByComparator);
	...
	public Task findByManagerId_Last(
		...
		Task task = fetchByManagerId_Last(managerId, orderByComparator);
	...
	public Task fetchByManagerId_Last(
		...
		List<Task> list = findByManagerId(
	...
	public Task[] findByManagerId_PrevAndNext(
		...
		try {
			...
			array[0] = getByManagerId_PrevAndNext(
				session, task, managerId, orderByComparator, true);

			array[1] = task;

			array[2] = getByManagerId_PrevAndNext(
				session, task, managerId, orderByComparator, false);
	...
	protected Task getByManagerId_PrevAndNext(
		Session session, Task task, long managerId,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Task> findByAssignedTo(long assignedTo, int start, int end) {
	 ...
	 */
	@Override
	public List<Task> findByAssignedTo(
	...
	public Task findByAssignedTo_First(
		...
		Task task = fetchByAssignedTo_First(assignedTo, orderByComparator);
	...
	public Task fetchByAssignedTo_First(
		...
		List<Task> list = findByAssignedTo(assignedTo, 0, 1, orderByComparator);
	...
	public Task findByAssignedTo_Last(
		...
		Task task = fetchByAssignedTo_Last(assignedTo, orderByComparator);
	...
	public Task fetchByAssignedTo_Last(
		...
		List<Task> list = findByAssignedTo(
	...
	public Task[] findByAssignedTo_PrevAndNext(
		...
		try {
			...
			array[0] = getByAssignedTo_PrevAndNext(
				session, task, assignedTo, orderByComparator, true);

			array[1] = task;

			array[2] = getByAssignedTo_PrevAndNext(
				session, task, assignedTo, orderByComparator, false);
	...
	protected Task getByAssignedTo_PrevAndNext(
		Session session, Task task, long assignedTo,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	...
	private FinderPath _finderPathWithPaginationFindByProjectIdAndManagerId;
	private FinderPath _finderPathWithoutPaginationFindByProjectIdAndManagerId;
	private FinderPath _finderPathCountByProjectIdAndManagerId;
	...
	public List<Task> findByProjectIdAndManagerId(
		...
		return findByProjectIdAndManagerId(
			projectId, managerId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Task> findByProjectIdAndManagerId(
		...
		return findByProjectIdAndManagerId(
			projectId, managerId, start, end, null);
	}
	...
	public List<Task> findByProjectIdAndManagerId(
		...
		return findByProjectIdAndManagerId(
			projectId, managerId, start, end, orderByComparator, true);
	}
	...
	public List<Task> findByProjectIdAndManagerId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByProjectIdAndManagerId;
				finderArgs = new Object[] {projectId, managerId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByProjectIdAndManagerId;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_PROJECTIDANDMANAGERID_PROJECTID_2);

			sb.append(_FINDER_COLUMN_PROJECTIDANDMANAGERID_MANAGERID_2);
	...
	public Task findByProjectIdAndManagerId_First(
		...
		Task task = fetchByProjectIdAndManagerId_First(
	...
	public Task fetchByProjectIdAndManagerId_First(
		...
		List<Task> list = findByProjectIdAndManagerId(
			projectId, managerId, 0, 1, orderByComparator);
	...
	public Task findByProjectIdAndManagerId_Last(
		...
		Task task = fetchByProjectIdAndManagerId_Last(
			projectId, managerId, orderByComparator);
	...
	public Task fetchByProjectIdAndManagerId_Last(
		...
		int count = countByProjectIdAndManagerId(projectId, managerId);
		...
		List<Task> list = findByProjectIdAndManagerId(
			projectId, managerId, count - 1, count, orderByComparator);
	...
	public Task[] findByProjectIdAndManagerId_PrevAndNext(
		...
		try {
			...
			array[0] = getByProjectIdAndManagerId_PrevAndNext(
				session, task, projectId, managerId, orderByComparator, true);

			array[1] = task;

			array[2] = getByProjectIdAndManagerId_PrevAndNext(
				session, task, projectId, managerId, orderByComparator, false);
	...
	protected Task getByProjectIdAndManagerId_PrevAndNext(
		Session session, Task task, long projectId, long managerId,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	...
	public void removeByProjectIdAndManagerId(long projectId, long managerId) {
		for (Task task :
				findByProjectIdAndManagerId(
					projectId, managerId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countByProjectIdAndManagerId(long projectId, long managerId) {
		FinderPath finderPath = _finderPathCountByProjectIdAndManagerId;

		Object[] finderArgs = new Object[] {projectId, managerId};
	...
	private static final String
		_FINDER_COLUMN_PROJECTIDANDMANAGERID_PROJECTID_2 =
			"task.projectId = ? AND ";

	private static final String
		_FINDER_COLUMN_PROJECTIDANDMANAGERID_MANAGERID_2 = "task.managerId = ?";

	private FinderPath _finderPathWithPaginationFindByProjectIdAndAssigneeId;
	private FinderPath _finderPathWithoutPaginationFindByProjectIdAndAssigneeId;
	private FinderPath _finderPathCountByProjectIdAndAssigneeId;
	...
	public List<Task> findByProjectIdAndAssigneeId(
		...
		return findByProjectIdAndAssigneeId(
			projectId, assignedTo, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Task> findByProjectIdAndAssigneeId(
		...
		return findByProjectIdAndAssigneeId(
			projectId, assignedTo, start, end, null);
	}
	...
	public List<Task> findByProjectIdAndAssigneeId(
		...
		return findByProjectIdAndAssigneeId(
			projectId, assignedTo, start, end, orderByComparator, true);
	}
	...
	public List<Task> findByProjectIdAndAssigneeId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByProjectIdAndAssigneeId;
				finderArgs = new Object[] {projectId, assignedTo};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByProjectIdAndAssigneeId;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_PROJECTIDANDASSIGNEEID_PROJECTID_2);

			sb.append(_FINDER_COLUMN_PROJECTIDANDASSIGNEEID_ASSIGNEDTO_2);
	...
	public Task findByProjectIdAndAssigneeId_First(
		...
		Task task = fetchByProjectIdAndAssigneeId_First(
	...
	public Task fetchByProjectIdAndAssigneeId_First(
		...
		List<Task> list = findByProjectIdAndAssigneeId(
			projectId, assignedTo, 0, 1, orderByComparator);
	...
	public Task findByProjectIdAndAssigneeId_Last(
		...
		Task task = fetchByProjectIdAndAssigneeId_Last(
			projectId, assignedTo, orderByComparator);
	...
	public Task fetchByProjectIdAndAssigneeId_Last(
		...
		int count = countByProjectIdAndAssigneeId(projectId, assignedTo);
		...
		List<Task> list = findByProjectIdAndAssigneeId(
			projectId, assignedTo, count - 1, count, orderByComparator);
	...
	public Task[] findByProjectIdAndAssigneeId_PrevAndNext(
		...
		try {
			...
			array[0] = getByProjectIdAndAssigneeId_PrevAndNext(
				session, task, projectId, assignedTo, orderByComparator, true);

			array[1] = task;

			array[2] = getByProjectIdAndAssigneeId_PrevAndNext(
				session, task, projectId, assignedTo, orderByComparator, false);
	...
	protected Task getByProjectIdAndAssigneeId_PrevAndNext(
		Session session, Task task, long projectId, long assignedTo,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public void removeByProjectIdAndAssigneeId(
		long projectId, long assignedTo) {

		for (Task task :
				findByProjectIdAndAssigneeId(
					projectId, assignedTo, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countByProjectIdAndAssigneeId(long projectId, long assignedTo) {
		FinderPath finderPath = _finderPathCountByProjectIdAndAssigneeId;

		Object[] finderArgs = new Object[] {projectId, assignedTo};
	...
	private static final String
		_FINDER_COLUMN_PROJECTIDANDASSIGNEEID_PROJECTID_2 =
			"task.projectId = ? AND ";

	private static final String
		_FINDER_COLUMN_PROJECTIDANDASSIGNEEID_ASSIGNEDTO_2 =
			"task.assignedTo = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByProjectIdAndManagerId = new FinderPath(
			...
			new String[] {"projectId", "managerId"}, true);
		...
		_finderPathCountByProjectIdAndManagerId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByProjectIdAndManagerId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"projectId", "managerId"}, false);

		_finderPathWithPaginationFindByProjectIdAndAssigneeId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByProjectIdAndAssigneeId",
			new String[] {
				Long.class.getName(), Long.class.getName(),
			...
			new String[] {"projectId", "assignedTo"}, true);
		...
		_finderPathCountByProjectIdAndAssigneeId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByProjectIdAndAssigneeId",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"projectId", "assignedTo"}, false);
