...
import com.ax.hrms.service.HolidayService;
...
/**
 * Provides the base implementation for the holiday remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.HolidayServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.HolidayServiceImpl
 * @generated
 */
public abstract class HolidayServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HolidayService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HolidayService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.HolidayServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HolidayService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		holidayService = (HolidayService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HolidayService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.HolidayLocalService holidayLocalService;
