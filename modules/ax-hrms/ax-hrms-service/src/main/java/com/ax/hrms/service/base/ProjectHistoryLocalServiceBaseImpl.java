...
/**
 * Provides the base implementation for the project history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.ProjectHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.ProjectHistoryLocalServiceImpl
 * @generated
 */
public abstract class ProjectHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ProjectHistoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProjectHistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.ProjectHistoryLocalServiceUtil</code>.
	 */
	...
	public ProjectHistory addProjectHistory(ProjectHistory projectHistory) {
		...
		return projectHistoryPersistence.update(projectHistory);
	}
	...
	public ProjectHistory createProjectHistory(long projectHistoryId) {
		return projectHistoryPersistence.create(projectHistoryId);
	}
	...
	public ProjectHistory deleteProjectHistory(long projectHistoryId)
		...
		return projectHistoryPersistence.remove(projectHistoryId);
	}
	...
	public ProjectHistory deleteProjectHistory(ProjectHistory projectHistory) {
		return projectHistoryPersistence.remove(projectHistory);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return projectHistoryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProjectHistory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return projectHistoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return projectHistoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProjectHistory fetchProjectHistory(long projectHistoryId) {
		return projectHistoryPersistence.fetchByPrimaryKey(projectHistoryId);
	}
	...
	public ProjectHistory fetchProjectHistoryByUuidAndGroupId(
		...
		return projectHistoryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProjectHistory getProjectHistory(long projectHistoryId)
		...
		return projectHistoryPersistence.findByPrimaryKey(projectHistoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectHistoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectHistory.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("projectHistoryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			projectHistoryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectHistory.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ProjectHistory>() {

				@Override
				public void performAction(ProjectHistory projectHistory)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, projectHistory);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return projectHistoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProjectHistoryLocalServiceImpl#deleteProjectHistory(ProjectHistory) to avoid orphaned data");
		}

		return projectHistoryLocalService.deleteProjectHistory(
			(ProjectHistory)persistedModel);
	}

	@Override
	public BasePersistence<ProjectHistory> getBasePersistence() {
		return projectHistoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return projectHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProjectHistory> getProjectHistoriesByUuidAndCompanyId(
		...
		return projectHistoryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProjectHistory> getProjectHistoriesByUuidAndCompanyId(
		...
		return projectHistoryPersistence.findByUuid_C(
	...
	public ProjectHistory getProjectHistoryByUuidAndGroupId(
		...
		return projectHistoryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProjectHistory> getProjectHistories(int start, int end) {
		return projectHistoryPersistence.findAll(start, end);
	}
	...
	public int getProjectHistoriesCount() {
		return projectHistoryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProjectHistoryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		projectHistoryLocalService = (ProjectHistoryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectHistoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectHistoryPersistence.getDataSource();
	...
	protected ProjectHistoryLocalService projectHistoryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProjectHistoryLocalServiceBaseImpl.class);
