 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeAddressLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeAddressLocalServiceImpl
 * @generated
 */
public abstract class EmployeeAddressLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeAddressLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeAddressLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return employeeAddressPersistence.dslQuery(dslQuery);
	}
	 ...
	 */
	@Override
	public EmployeeAddress fetchEmployeeAddressByUuidAndGroupId(
		String uuid, long groupId) {

		return employeeAddressPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<EmployeeAddress>() {

				@Override
				public void performAction(EmployeeAddress employeeAddress)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeAddress);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EmployeeAddressLocalServiceImpl#deleteEmployeeAddress(EmployeeAddress) to avoid orphaned data");
		}
	 ...
	 */
	@Override
	public List<EmployeeAddress> getEmployeeAddressesByUuidAndCompanyId(
		String uuid, long companyId) {

		return employeeAddressPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EmployeeAddress> getEmployeeAddressesByUuidAndCompanyId(
		...
		return employeeAddressPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public EmployeeAddress getEmployeeAddressByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return employeeAddressPersistence.findByUUID_G(uuid, groupId);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeAddressLocalServiceBaseImpl.class);
