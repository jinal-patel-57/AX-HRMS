...
import com.ax.hrms.service.AppraisalHistoryService;
...
/**
 * Provides the base implementation for the appraisal history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalHistoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalHistoryServiceImpl
 * @generated
 */
public abstract class AppraisalHistoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalHistoryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalHistoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalHistoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalHistoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appraisalHistoryService = (AppraisalHistoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalHistoryService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalHistoryLocalService
		appraisalHistoryLocalService;

	protected AppraisalHistoryService appraisalHistoryService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalHistoryServiceBaseImpl.class);
