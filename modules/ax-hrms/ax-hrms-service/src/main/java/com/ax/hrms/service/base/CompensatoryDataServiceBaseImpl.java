...
import com.ax.hrms.service.CompensatoryDataService;
...
/**
 * Provides the base implementation for the compensatory data remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.CompensatoryDataServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.CompensatoryDataServiceImpl
 * @generated
 */
public abstract class CompensatoryDataServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompensatoryDataService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompensatoryDataService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.CompensatoryDataServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompensatoryDataService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		compensatoryDataService = (CompensatoryDataService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompensatoryDataService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.CompensatoryDataLocalService
		compensatoryDataLocalService;

	protected CompensatoryDataService compensatoryDataService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompensatoryDataServiceBaseImpl.class);
