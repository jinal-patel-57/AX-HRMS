...
import com.ax.hrms.service.AppraisalReminderService;
...
/**
 * Provides the base implementation for the appraisal reminder remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalReminderServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalReminderServiceImpl
 * @generated
 */
public abstract class AppraisalReminderServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalReminderService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalReminderService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalReminderServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalReminderService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appraisalReminderService = (AppraisalReminderService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalReminderService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalReminderLocalService
		appraisalReminderLocalService;

	protected AppraisalReminderService appraisalReminderService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalReminderServiceBaseImpl.class);
