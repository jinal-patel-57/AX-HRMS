...
import com.ax.hrms.service.AppraisalHistoryLocalService;
...
/**
 * Provides the base implementation for the appraisal history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalHistoryLocalServiceImpl
 * @generated
 */
public abstract class AppraisalHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AppraisalHistoryLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalHistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalHistoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public AppraisalHistory addAppraisalHistory(
		AppraisalHistory appraisalHistory) {

		appraisalHistory.setNew(true);

		return appraisalHistoryPersistence.update(appraisalHistory);
	}
	...
	public AppraisalHistory createAppraisalHistory(long appraisalId) {
		return appraisalHistoryPersistence.create(appraisalId);
	}
	...
	@Override
	public AppraisalHistory deleteAppraisalHistory(long appraisalId)
		throws PortalException {

		return appraisalHistoryPersistence.remove(appraisalId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AppraisalHistory deleteAppraisalHistory(
		AppraisalHistory appraisalHistory) {

		return appraisalHistoryPersistence.remove(appraisalHistory);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return appraisalHistoryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AppraisalHistory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return appraisalHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return appraisalHistoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return appraisalHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return appraisalHistoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AppraisalHistory fetchAppraisalHistory(long appraisalId) {
		return appraisalHistoryPersistence.fetchByPrimaryKey(appraisalId);
	}
	 ...
	 */
	@Override
	public AppraisalHistory fetchAppraisalHistoryByUuidAndGroupId(
		String uuid, long groupId) {

		return appraisalHistoryPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public AppraisalHistory getAppraisalHistory(long appraisalId)
		throws PortalException {

		return appraisalHistoryPersistence.findByPrimaryKey(appraisalId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			appraisalHistoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AppraisalHistory.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AppraisalHistory.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<AppraisalHistory>() {

				@Override
				public void performAction(AppraisalHistory appraisalHistory)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, appraisalHistory);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return appraisalHistoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AppraisalHistoryLocalServiceImpl#deleteAppraisalHistory(AppraisalHistory) to avoid orphaned data");
		}

		return appraisalHistoryLocalService.deleteAppraisalHistory(
			(AppraisalHistory)persistedModel);
	}

	@Override
	public BasePersistence<AppraisalHistory> getBasePersistence() {
		return appraisalHistoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return appraisalHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AppraisalHistory> getAppraisalHistoriesByUuidAndCompanyId(
		String uuid, long companyId) {

		return appraisalHistoryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AppraisalHistory> getAppraisalHistoriesByUuidAndCompanyId(
		...
		return appraisalHistoryPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public AppraisalHistory getAppraisalHistoryByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return appraisalHistoryPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<AppraisalHistory> getAppraisalHistories(int start, int end) {
		return appraisalHistoryPersistence.findAll(start, end);
	}
	...
	public int getAppraisalHistoriesCount() {
		return appraisalHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AppraisalHistory updateAppraisalHistory(
		AppraisalHistory appraisalHistory) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalHistoryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		appraisalHistoryLocalService = (AppraisalHistoryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalHistoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = appraisalHistoryPersistence.getDataSource();
	...
	protected AppraisalHistoryLocalService appraisalHistoryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalHistoryLocalServiceBaseImpl.class);
