...
/**
 * Provides the base implementation for the task review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.TaskReviewLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.TaskReviewLocalServiceImpl
 * @generated
 */
public abstract class TaskReviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TaskReviewLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TaskReviewLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.TaskReviewLocalServiceUtil</code>.
	 */
	...
	public TaskReview addTaskReview(TaskReview taskReview) {
		...
		return taskReviewPersistence.update(taskReview);
	}
	...
	public TaskReview createTaskReview(long taskReviewId) {
		return taskReviewPersistence.create(taskReviewId);
	}
	...
	public TaskReview deleteTaskReview(long taskReviewId)
		...
		return taskReviewPersistence.remove(taskReviewId);
	}
	...
	public TaskReview deleteTaskReview(TaskReview taskReview) {
		return taskReviewPersistence.remove(taskReview);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return taskReviewPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TaskReview.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return taskReviewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return taskReviewPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return taskReviewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return taskReviewPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TaskReview fetchTaskReview(long taskReviewId) {
		return taskReviewPersistence.fetchByPrimaryKey(taskReviewId);
	}
	...
	public TaskReview fetchTaskReviewByUuidAndGroupId(
		...
		return taskReviewPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public TaskReview getTaskReview(long taskReviewId) throws PortalException {
		return taskReviewPersistence.findByPrimaryKey(taskReviewId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(taskReviewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TaskReview.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("taskReviewId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TaskReview.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<TaskReview>() {

				@Override
				public void performAction(TaskReview taskReview)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, taskReview);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return taskReviewPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TaskReviewLocalServiceImpl#deleteTaskReview(TaskReview) to avoid orphaned data");
		}

		return taskReviewLocalService.deleteTaskReview(
			(TaskReview)persistedModel);
	}

	@Override
	public BasePersistence<TaskReview> getBasePersistence() {
		return taskReviewPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return taskReviewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TaskReview> getTaskReviewsByUuidAndCompanyId(
		...
		return taskReviewPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<TaskReview> getTaskReviewsByUuidAndCompanyId(
		...
		return taskReviewPersistence.findByUuid_C(
	...
	public TaskReview getTaskReviewByUuidAndGroupId(String uuid, long groupId)
		...
		return taskReviewPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<TaskReview> getTaskReviews(int start, int end) {
		return taskReviewPersistence.findAll(start, end);
	}
	...
	public int getTaskReviewsCount() {
		return taskReviewPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TaskReviewLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		taskReviewLocalService = (TaskReviewLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaskReviewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = taskReviewPersistence.getDataSource();
	...
	protected TaskReviewLocalService taskReviewLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TaskReviewLocalServiceBaseImpl.class);
