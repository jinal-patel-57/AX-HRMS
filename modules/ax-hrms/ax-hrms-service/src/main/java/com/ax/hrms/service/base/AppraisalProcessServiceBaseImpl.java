...
import com.ax.hrms.service.AppraisalProcessService;
...
/**
 * Provides the base implementation for the appraisal process remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.AppraisalProcessServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.AppraisalProcessServiceImpl
 * @generated
 */
public abstract class AppraisalProcessServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AppraisalProcessService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AppraisalProcessService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.AppraisalProcessServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AppraisalProcessService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		appraisalProcessService = (AppraisalProcessService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalProcessService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.AppraisalProcessLocalService
		appraisalProcessLocalService;

	protected AppraisalProcessService appraisalProcessService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AppraisalProcessServiceBaseImpl.class);
