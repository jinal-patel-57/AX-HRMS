...
/**
 * Provides the base implementation for the employee education local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.EmployeeEducationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.EmployeeEducationLocalServiceImpl
 * @generated
 */
public abstract class EmployeeEducationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EmployeeEducationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeEducationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.EmployeeEducationLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmployeeEducation addEmployeeEducation(
		EmployeeEducation employeeEducation) {

		employeeEducation.setNew(true);

		return employeeEducationPersistence.update(employeeEducation);
	}
	...
	public EmployeeEducation createEmployeeEducation(long educationId) {
		return employeeEducationPersistence.create(educationId);
	}
	...
	@Override
	public EmployeeEducation deleteEmployeeEducation(long educationId)
		throws PortalException {

		return employeeEducationPersistence.remove(educationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmployeeEducation deleteEmployeeEducation(
		EmployeeEducation employeeEducation) {

		return employeeEducationPersistence.remove(employeeEducation);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return employeeEducationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmployeeEducation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeEducationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return employeeEducationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeEducationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return employeeEducationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmployeeEducation fetchEmployeeEducation(long educationId) {
		return employeeEducationPersistence.fetchByPrimaryKey(educationId);
	}
	 ...
	 */
	@Override
	public EmployeeEducation fetchEmployeeEducationByUuidAndGroupId(
		String uuid, long groupId) {

		return employeeEducationPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public EmployeeEducation getEmployeeEducation(long educationId)
		throws PortalException {

		return employeeEducationPersistence.findByPrimaryKey(educationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			employeeEducationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeEducation.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmployeeEducation.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(EmployeeEducation employeeEducation)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, employeeEducation);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return employeeEducationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EmployeeEducationLocalServiceImpl#deleteEmployeeEducation(EmployeeEducation) to avoid orphaned data");
		}

		return employeeEducationLocalService.deleteEmployeeEducation(
			(EmployeeEducation)persistedModel);
	}

	@Override
	public BasePersistence<EmployeeEducation> getBasePersistence() {
		return employeeEducationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return employeeEducationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeEducation> getEmployeeEducationsByUuidAndCompanyId(
		String uuid, long companyId) {

		return employeeEducationPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EmployeeEducation> getEmployeeEducationsByUuidAndCompanyId(
		...
		return employeeEducationPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public EmployeeEducation getEmployeeEducationByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return employeeEducationPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<EmployeeEducation> getEmployeeEducations(int start, int end) {
		return employeeEducationPersistence.findAll(start, end);
	}
	...
	public int getEmployeeEducationsCount() {
		return employeeEducationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmployeeEducationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		employeeEducationLocalService = (EmployeeEducationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeEducationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = employeeEducationPersistence.getDataSource();
	...
	protected EmployeeEducationLocalService employeeEducationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmployeeEducationLocalServiceBaseImpl.class);
