...
/**
 * The arguments resolver class for retrieving value from EmployeeDocument.
 *
...
@Component(
	property = {
		"class.name=com.ax.hrms.model.impl.EmployeeDocumentImpl",
		"table.name=ax_EmployeeDocument"
	},
	service = ArgumentsResolver.class
)
public class EmployeeDocumentModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(employeeDocumentModelImpl, columnNames, original);
		}
	...
	public String getClassName() {
		return EmployeeDocumentImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return EmployeeDocumentTable.INSTANCE.getTableName();
	}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				arguments[i] = employeeDocumentModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
