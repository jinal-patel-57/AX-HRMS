...
import com.ax.hrms.model.EmployeeAddressTable;
import com.ax.hrms.model.impl.EmployeeAddressImpl;
import com.ax.hrms.model.impl.EmployeeAddressModelImpl;
import com.ax.hrms.service.persistence.EmployeeAddressPersistence;
import com.ax.hrms.service.persistence.EmployeeAddressUtil;
...
public class EmployeeAddressPersistenceImpl
	 ...
	 */
	@Override
	public List<EmployeeAddress> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<EmployeeAddress> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<EmployeeAddress> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (EmployeeAddress employeeAddress : list) {
					if (!uuid.equals(employeeAddress.getUuid())) {
						list = null;
	...
	public EmployeeAddress findByUuid_First(
		...
		EmployeeAddress employeeAddress = fetchByUuid_First(
	...
	public EmployeeAddress fetchByUuid_First(
		...
		List<EmployeeAddress> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public EmployeeAddress findByUuid_Last(
		...
		EmployeeAddress employeeAddress = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public EmployeeAddress fetchByUuid_Last(
		...
		List<EmployeeAddress> list = findByUuid(
	...
	public EmployeeAddress[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, employeeAddress, uuid, orderByComparator, true);

			array[1] = employeeAddress;

			array[2] = getByUuid_PrevAndNext(
				session, employeeAddress, uuid, orderByComparator, false);
	...
	protected EmployeeAddress getByUuid_PrevAndNext(
		Session session, EmployeeAddress employeeAddress, String uuid,
		OrderByComparator<EmployeeAddress> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"employeeAddress.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(employeeAddress.uuid IS NULL OR employeeAddress.uuid = '')";
	...
	public EmployeeAddress findByUUID_G(String uuid, long groupId)
		...
		EmployeeAddress employeeAddress = fetchByUUID_G(uuid, groupId);
	...
	public EmployeeAddress fetchByUUID_G(
		...
		if (result instanceof EmployeeAddress) {
			EmployeeAddress employeeAddress = (EmployeeAddress)result;

			if (!Objects.equals(uuid, employeeAddress.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					EmployeeAddress employeeAddress = list.get(0);
	...
	public EmployeeAddress removeByUUID_G(String uuid, long groupId)
		...
		EmployeeAddress employeeAddress = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"employeeAddress.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(employeeAddress.uuid IS NULL OR employeeAddress.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"employeeAddress.groupId = ?";
	 ...
	 */
	@Override
	public List<EmployeeAddress> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<EmployeeAddress> findByUuid_C(
	...
	public EmployeeAddress findByUuid_C_First(
		...
		EmployeeAddress employeeAddress = fetchByUuid_C_First(
	...
	public EmployeeAddress fetchByUuid_C_First(
		...
		List<EmployeeAddress> list = findByUuid_C(
	...
	public EmployeeAddress findByUuid_C_Last(
		...
		EmployeeAddress employeeAddress = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public EmployeeAddress[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, employeeAddress, uuid, companyId, orderByComparator,
				true);
	...
	protected EmployeeAddress getByUuid_C_PrevAndNext(
		Session session, EmployeeAddress employeeAddress, String uuid,
		long companyId, OrderByComparator<EmployeeAddress> orderByComparator,
		boolean previous) {
	...
	public EmployeeAddress findByEmployeeId(long employeeId)
		...
		EmployeeAddress employeeAddress = fetchByEmployeeId(employeeId);
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"EmployeeAddressPersistenceImpl.fetchByEmployeeId(long, boolean) with parameters (" +
	...
	public EmployeeAddress removeByEmployeeId(long employeeId)
		...
		EmployeeAddress employeeAddress = findByEmployeeId(employeeId);
	...
	public EmployeeAddressPersistenceImpl() {
		...
		setTable(EmployeeAddressTable.INSTANCE);
	}
	...
	public void cacheResult(EmployeeAddress employeeAddress) {
		...
		finderCache.putResult(
			...
			new Object[] {
				employeeAddress.getUuid(), employeeAddress.getGroupId()
			},
			employeeAddress);

		finderCache.putResult(
			_finderPathFetchByEmployeeId,
			new Object[] {employeeAddress.getEmployeeId()}, employeeAddress);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(EmployeeAddressImpl.class);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			employeeAddressModelImpl.getUuid(),
			employeeAddressModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathFetchByUUID_G, args, employeeAddressModelImpl);

		args = new Object[] {employeeAddressModelImpl.getEmployeeId()};

		finderCache.putResult(
			_finderPathFetchByEmployeeId, args, employeeAddressModelImpl);
	}
	...
	public EmployeeAddress updateImpl(EmployeeAddress employeeAddress) {
		...
		if (Validator.isNull(employeeAddress.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (employeeAddress.getCreateDate() == null)) {
			if (serviceContext == null) {
				employeeAddress.setCreateDate(date);
			}
			else {
		...
		if (!employeeAddressModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				employeeAddress.setModifiedDate(date);
			}
			else {
		...
		cacheUniqueFindersCache(employeeAddressModelImpl);
	...
	public void activate() {
		...
		EmployeeAddressUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		EmployeeAddressUtil.setPersistence(null);
