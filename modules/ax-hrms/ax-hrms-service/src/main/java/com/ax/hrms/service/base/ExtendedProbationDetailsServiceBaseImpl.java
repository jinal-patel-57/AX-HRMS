...
import com.ax.hrms.service.ExtendedProbationDetailsService;
...
/**
 * Provides the base implementation for the extended probation details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.service.impl.ExtendedProbationDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.service.impl.ExtendedProbationDetailsServiceImpl
 * @generated
 */
public abstract class ExtendedProbationDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ExtendedProbationDetailsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ExtendedProbationDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.service.ExtendedProbationDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ExtendedProbationDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		extendedProbationDetailsService =
			(ExtendedProbationDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExtendedProbationDetailsService.class.getName();
	}
	...
	@Reference
	protected com.ax.hrms.service.ExtendedProbationDetailsLocalService
		extendedProbationDetailsLocalService;

	protected ExtendedProbationDetailsService extendedProbationDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ExtendedProbationDetailsServiceBaseImpl.class);
