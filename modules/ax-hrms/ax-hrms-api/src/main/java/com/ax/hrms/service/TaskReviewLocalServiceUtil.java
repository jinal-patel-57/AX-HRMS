...
/**
 * Provides the local service utility for TaskReview. This utility wraps
 * <code>com.ax.hrms.service.impl.TaskReviewLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TaskReviewLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.service.impl.TaskReviewLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TaskReview addTaskReview(TaskReview taskReview) {
		return getService().addTaskReview(taskReview);
	}
	 ...
	 */
	public static TaskReview createTaskReview(long taskReviewId) {
		return getService().createTaskReview(taskReviewId);
	}
	 ...
	 */
	public static TaskReview deleteTaskReview(long taskReviewId)
		throws PortalException {

		return getService().deleteTaskReview(taskReviewId);
	}
	 ...
	 * @return the task review that was removed
	 */
	public static TaskReview deleteTaskReview(TaskReview taskReview) {
		return getService().deleteTaskReview(taskReview);
	}
	...
	public static TaskReview fetchTaskReview(long taskReviewId) {
		return getService().fetchTaskReview(taskReviewId);
	}
	 ...
	 */
	public static TaskReview fetchTaskReviewByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchTaskReviewByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a task review with the primary key could not be found
	 */
	public static TaskReview getTaskReview(long taskReviewId)
		throws PortalException {

		return getService().getTaskReview(taskReviewId);
	}
	 ...
	 */
	public static TaskReview getTaskReviewByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getTaskReviewByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<TaskReview> getTaskReviews(int start, int end) {
		return getService().getTaskReviews(start, end);
	}
	 ...
	 */
	public static List<TaskReview> getTaskReviewsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getTaskReviewsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<TaskReview> getTaskReviewsByUuidAndCompanyId(
		...
		return getService().getTaskReviewsByUuidAndCompanyId(
	 ...
	 */
	public static int getTaskReviewsCount() {
		return getService().getTaskReviewsCount();
	}
	 ...
	 */
	public static TaskReview updateTaskReview(TaskReview taskReview) {
		return getService().updateTaskReview(taskReview);
	}

	public static TaskReviewLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TaskReviewLocalService> _serviceSnapshot =
		new Snapshot<>(
			TaskReviewLocalServiceUtil.class, TaskReviewLocalService.class);
