...
public interface WorkFromHomeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ax.hrms.service.impl.WorkFromHomeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the work from home local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link WorkFromHomeLocalServiceUtil} if injection and service tracking are not available.
	 */
