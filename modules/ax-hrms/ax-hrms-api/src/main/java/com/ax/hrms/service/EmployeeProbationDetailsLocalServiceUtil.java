...
/**
 * Provides the local service utility for EmployeeProbationDetails. This utility wraps
 * <code>com.ax.hrms.service.impl.EmployeeProbationDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeProbationDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.service.impl.EmployeeProbationDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EmployeeProbationDetails addEmployeeProbationDetails(
		EmployeeProbationDetails employeeProbationDetails) {

		return getService().addEmployeeProbationDetails(
	 ...
	 */
	public static EmployeeProbationDetails createEmployeeProbationDetails(
		long probationDetailId) {

		return getService().createEmployeeProbationDetails(probationDetailId);
	}
	 ...
	 */
	public static EmployeeProbationDetails deleteEmployeeProbationDetails(
		EmployeeProbationDetails employeeProbationDetails) {

		return getService().deleteEmployeeProbationDetails(
			employeeProbationDetails);
	}
	...
	public static EmployeeProbationDetails deleteEmployeeProbationDetails(
		...
		return getService().deleteEmployeeProbationDetails(probationDetailId);
	}
	...
	public static EmployeeProbationDetails fetchEmployeeProbationDetails(
		long probationDetailId) {

		return getService().fetchEmployeeProbationDetails(probationDetailId);
	}
	 ...
	 */
	public static EmployeeProbationDetails
		fetchEmployeeProbationDetailsByUuidAndGroupId(
			String uuid, long groupId) {

		return getService().fetchEmployeeProbationDetailsByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a employee probation details with the primary key could not be found
	 */
	public static EmployeeProbationDetails getEmployeeProbationDetails(
			long probationDetailId)
		throws PortalException {

		return getService().getEmployeeProbationDetails(probationDetailId);
	}
	...
	public static EmployeeProbationDetails
		...
		return getService().getEmployeeProbationDetailsByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<EmployeeProbationDetails> getEmployeeProbationDetailses(
		int start, int end) {

		return getService().getEmployeeProbationDetailses(start, end);
	}
	 ...
	 */
	public static List<EmployeeProbationDetails>
		getEmployeeProbationDetailsesByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getEmployeeProbationDetailsesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getEmployeeProbationDetailsesCount() {
		return getService().getEmployeeProbationDetailsesCount();
	}
	 ...
	 */
	public static EmployeeProbationDetails updateEmployeeProbationDetails(
		EmployeeProbationDetails employeeProbationDetails) {

		return getService().updateEmployeeProbationDetails(
			employeeProbationDetails);
	}

	public static EmployeeProbationDetailsLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<EmployeeProbationDetailsLocalService>
		_serviceSnapshot = new Snapshot<>(
			EmployeeProbationDetailsLocalServiceUtil.class,
