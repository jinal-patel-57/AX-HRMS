...
/**
 * The persistence utility for the appraisal history service. This utility wraps <code>com.ax.hrms.service.persistence.impl.AppraisalHistoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AppraisalHistoryPersistence
 * @generated
 */
public class AppraisalHistoryUtil {
	 ...
	 */
	public static void clearCache(AppraisalHistory appraisalHistory) {
		getPersistence().clearCache(appraisalHistory);
	}
	 ...
	 */
	public static Map<Serializable, AppraisalHistory> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AppraisalHistory> findWithDynamicQuery(
	 ...
	 */
	public static AppraisalHistory update(AppraisalHistory appraisalHistory) {
		return getPersistence().update(appraisalHistory);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static AppraisalHistory update(
		AppraisalHistory appraisalHistory, ServiceContext serviceContext) {

		return getPersistence().update(appraisalHistory, serviceContext);
	}
	 ...
	 */
	public static List<AppraisalHistory> findByUuid(String uuid) {
	 ...
	 */
	public static List<AppraisalHistory> findByUuid(
	 ...
	 */
	public static AppraisalHistory findByUuid_First(
			String uuid, OrderByComparator<AppraisalHistory> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 */
	public static AppraisalHistory fetchByUuid_First(
		String uuid, OrderByComparator<AppraisalHistory> orderByComparator) {
	 ...
	 * @throws NoSuchAppraisalHistoryException if a matching appraisal history could not be found
	 */
	public static AppraisalHistory findByUuid_Last(
			String uuid, OrderByComparator<AppraisalHistory> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 */
	public static AppraisalHistory fetchByUuid_Last(
		String uuid, OrderByComparator<AppraisalHistory> orderByComparator) {
	 ...
	 */
	public static AppraisalHistory[] findByUuid_PrevAndNext(
			long appraisalId, String uuid,
			OrderByComparator<AppraisalHistory> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {

		return getPersistence().findByUuid_PrevAndNext(
			appraisalId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAppraisalHistoryException if a matching appraisal history could not be found
	 */
	public static AppraisalHistory findByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 */
	public static AppraisalHistory fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching appraisal history, or <code>null</code> if a matching appraisal history could not be found
	 */
	public static AppraisalHistory fetchByUUID_G(
	 ...
	 */
	public static AppraisalHistory removeByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 * @return the matching appraisal histories
	 */
	public static List<AppraisalHistory> findByUuid_C(
	 ...
	 * @throws NoSuchAppraisalHistoryException if a matching appraisal history could not be found
	 */
	public static AppraisalHistory findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AppraisalHistory> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 * @return the first matching appraisal history, or <code>null</code> if a matching appraisal history could not be found
	 */
	public static AppraisalHistory fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AppraisalHistory> orderByComparator) {
	 ...
	 * @throws NoSuchAppraisalHistoryException if a matching appraisal history could not be found
	 */
	public static AppraisalHistory findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AppraisalHistory> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 * @return the last matching appraisal history, or <code>null</code> if a matching appraisal history could not be found
	 */
	public static AppraisalHistory fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AppraisalHistory> orderByComparator) {
	 ...
	 * @throws NoSuchAppraisalHistoryException if a appraisal history with the primary key could not be found
	 */
	public static AppraisalHistory[] findByUuid_C_PrevAndNext(
			long appraisalId, String uuid, long companyId,
			OrderByComparator<AppraisalHistory> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {

		return getPersistence().findByUuid_C_PrevAndNext(
			appraisalId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(AppraisalHistory appraisalHistory) {
		getPersistence().cacheResult(appraisalHistory);
	}
	 ...
	 */
	public static void cacheResult(List<AppraisalHistory> appraisalHistories) {
		getPersistence().cacheResult(appraisalHistories);
	}
	 ...
	 */
	public static AppraisalHistory create(long appraisalId) {
	 ...
	 * @throws NoSuchAppraisalHistoryException if a appraisal history with the primary key could not be found
	 */
	public static AppraisalHistory remove(long appraisalId)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {

		return getPersistence().remove(appraisalId);
	}

	public static AppraisalHistory updateImpl(
		AppraisalHistory appraisalHistory) {

		return getPersistence().updateImpl(appraisalHistory);
	}
	 ...
	 * @throws NoSuchAppraisalHistoryException if a appraisal history with the primary key could not be found
	 */
	public static AppraisalHistory findByPrimaryKey(long appraisalId)
		throws com.ax.hrms.exception.NoSuchAppraisalHistoryException {
	 ...
	 */
	public static AppraisalHistory fetchByPrimaryKey(long appraisalId) {
	 ...
	 */
	public static List<AppraisalHistory> findAll() {
	 ...
	 */
	public static List<AppraisalHistory> findAll(int start, int end) {
	...
	public static AppraisalHistoryPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(AppraisalHistoryPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile AppraisalHistoryPersistence _persistence;
