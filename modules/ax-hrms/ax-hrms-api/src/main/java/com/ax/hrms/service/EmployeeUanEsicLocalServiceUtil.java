...
/**
 * Provides the local service utility for EmployeeUanEsic. This utility wraps
 * <code>com.ax.hrms.service.impl.EmployeeUanEsicLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeUanEsicLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.service.impl.EmployeeUanEsicLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EmployeeUanEsic addEmployeeUanEsic(
		EmployeeUanEsic employeeUanEsic) {

		return getService().addEmployeeUanEsic(employeeUanEsic);
	}
	 ...
	 */
	public static EmployeeUanEsic createEmployeeUanEsic(long uanEsicId) {
		return getService().createEmployeeUanEsic(uanEsicId);
	}
	 ...
	 */
	public static EmployeeUanEsic deleteEmployeeUanEsic(
		EmployeeUanEsic employeeUanEsic) {

		return getService().deleteEmployeeUanEsic(employeeUanEsic);
	}
	 ...
	 */
	public static EmployeeUanEsic deleteEmployeeUanEsic(long uanEsicId)
		throws PortalException {

		return getService().deleteEmployeeUanEsic(uanEsicId);
	}
	...
	public static EmployeeUanEsic fetchEmployeeUanEsic(long uanEsicId) {
		return getService().fetchEmployeeUanEsic(uanEsicId);
	}
	 ...
	 */
	public static EmployeeUanEsic fetchEmployeeUanEsicByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchEmployeeUanEsicByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a employee uan esic with the primary key could not be found
	 */
	public static EmployeeUanEsic getEmployeeUanEsic(long uanEsicId)
		throws PortalException {

		return getService().getEmployeeUanEsic(uanEsicId);
	}
	 ...
	 */
	public static EmployeeUanEsic getEmployeeUanEsicByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getEmployeeUanEsicByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<EmployeeUanEsic> getEmployeeUanEsics(
		int start, int end) {

		return getService().getEmployeeUanEsics(start, end);
	}
	 ...
	 */
	public static List<EmployeeUanEsic> getEmployeeUanEsicsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getEmployeeUanEsicsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getEmployeeUanEsicsCount() {
		return getService().getEmployeeUanEsicsCount();
	}
	 ...
	 */
	public static EmployeeUanEsic updateEmployeeUanEsic(
		EmployeeUanEsic employeeUanEsic) {

		return getService().updateEmployeeUanEsic(employeeUanEsic);
	}

	public static EmployeeUanEsicLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<EmployeeUanEsicLocalService>
		_serviceSnapshot = new Snapshot<>(
			EmployeeUanEsicLocalServiceUtil.class,
			EmployeeUanEsicLocalService.class);
