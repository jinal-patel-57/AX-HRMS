...
/**
 * The persistence utility for the leave type view permit service. This utility wraps <code>com.ax.hrms.service.persistence.impl.LeaveTypeViewPermitPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LeaveTypeViewPermitPersistence
 * @generated
 */
public class LeaveTypeViewPermitUtil {
	 ...
	 */
	public static void clearCache(LeaveTypeViewPermit leaveTypeViewPermit) {
		getPersistence().clearCache(leaveTypeViewPermit);
	}
	 ...
	 */
	public static Map<Serializable, LeaveTypeViewPermit> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LeaveTypeViewPermit> findWithDynamicQuery(
	 ...
	 */
	public static LeaveTypeViewPermit update(
		LeaveTypeViewPermit leaveTypeViewPermit) {

		return getPersistence().update(leaveTypeViewPermit);
	}
	...
	public static LeaveTypeViewPermit update(
		...
		return getPersistence().update(leaveTypeViewPermit, serviceContext);
	}
	 ...
	 */
	public static List<LeaveTypeViewPermit> findByUuid(String uuid) {
	 ...
	 */
	public static List<LeaveTypeViewPermit> findByUuid(
	 ...
	 */
	public static LeaveTypeViewPermit findByUuid_First(
			String uuid,
			OrderByComparator<LeaveTypeViewPermit> orderByComparator)
	 ...
	 */
	public static LeaveTypeViewPermit fetchByUuid_First(
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit findByUuid_Last(
			String uuid,
			OrderByComparator<LeaveTypeViewPermit> orderByComparator)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {
	 ...
	 */
	public static LeaveTypeViewPermit fetchByUuid_Last(
		String uuid, OrderByComparator<LeaveTypeViewPermit> orderByComparator) {
	 ...
	 */
	public static LeaveTypeViewPermit[] findByUuid_PrevAndNext(
			long leaveTypeViewPermitId, String uuid,
			OrderByComparator<LeaveTypeViewPermit> orderByComparator)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {

		return getPersistence().findByUuid_PrevAndNext(
			leaveTypeViewPermitId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit findByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {
	 ...
	 */
	public static LeaveTypeViewPermit fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching leave type view permit, or <code>null</code> if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit fetchByUUID_G(
	 ...
	 */
	public static LeaveTypeViewPermit removeByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {
	 ...
	 * @return the matching leave type view permits
	 */
	public static List<LeaveTypeViewPermit> findByUuid_C(
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<LeaveTypeViewPermit> orderByComparator)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {
	 ...
	 * @return the first matching leave type view permit, or <code>null</code> if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<LeaveTypeViewPermit> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<LeaveTypeViewPermit> orderByComparator)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {
	 ...
	 * @return the last matching leave type view permit, or <code>null</code> if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<LeaveTypeViewPermit> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a leave type view permit with the primary key could not be found
	 */
	public static LeaveTypeViewPermit[] findByUuid_C_PrevAndNext(
			long leaveTypeViewPermitId, String uuid, long companyId,
			OrderByComparator<LeaveTypeViewPermit> orderByComparator)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {

		return getPersistence().findByUuid_C_PrevAndNext(
			leaveTypeViewPermitId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching leave type view permit, or <code>null</code> if a matching leave type view permit could not be found
	 */
	public static LeaveTypeViewPermit fetchByEmployeeIdAndLeaveTypeMasterId(
		long employeeId, long leaveTypeMasterId) {
	 ...
	 * @return the leave type view permit that was removed
	 */
	public static LeaveTypeViewPermit removeByEmployeeIdAndLeaveTypeMasterId(
			long employeeId, long leaveTypeMasterId)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {
	 ...
	 */
	public static void cacheResult(LeaveTypeViewPermit leaveTypeViewPermit) {
		getPersistence().cacheResult(leaveTypeViewPermit);
	}
	...
	public static void cacheResult(
		List<LeaveTypeViewPermit> leaveTypeViewPermits) {

		getPersistence().cacheResult(leaveTypeViewPermits);
	}
	 ...
	 */
	public static LeaveTypeViewPermit create(long leaveTypeViewPermitId) {
		return getPersistence().create(leaveTypeViewPermitId);
	}
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a leave type view permit with the primary key could not be found
	 */
	public static LeaveTypeViewPermit remove(long leaveTypeViewPermitId)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {

		return getPersistence().remove(leaveTypeViewPermitId);
	}

	public static LeaveTypeViewPermit updateImpl(
		LeaveTypeViewPermit leaveTypeViewPermit) {

		return getPersistence().updateImpl(leaveTypeViewPermit);
	}
	 ...
	 * @throws NoSuchLeaveTypeViewPermitException if a leave type view permit with the primary key could not be found
	 */
	public static LeaveTypeViewPermit findByPrimaryKey(
			long leaveTypeViewPermitId)
		throws com.ax.hrms.exception.NoSuchLeaveTypeViewPermitException {

		return getPersistence().findByPrimaryKey(leaveTypeViewPermitId);
	}
	 ...
	 */
	public static LeaveTypeViewPermit fetchByPrimaryKey(
		long leaveTypeViewPermitId) {

		return getPersistence().fetchByPrimaryKey(leaveTypeViewPermitId);
	}
	 ...
	 */
	public static List<LeaveTypeViewPermit> findAll() {
	 ...
	 */
	public static List<LeaveTypeViewPermit> findAll(int start, int end) {
	...
	public static LeaveTypeViewPermitPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		LeaveTypeViewPermitPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile LeaveTypeViewPermitPersistence _persistence;
