 ...
 * <code>com.ax.hrms.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Task> findByProjectId(
		...
		return getService().findByProjectId(projectId, start, end);
	}

	public static List<Task> findByProjectIdAndAssigneeId(
		long projectId, long assignedTo) {

		return getService().findByProjectIdAndAssigneeId(projectId, assignedTo);
	}

	public static List<Task> findByProjectIdAndAssigneeId(
		long projectId, long assignedTo, int start, int end) {

		return getService().findByProjectIdAndAssigneeId(
	...
	public static List<Task> findByProjectIdAndManagerId(
		...
		return getService().findByProjectIdAndManagerId(projectId, managerId);
	}

	public static List<Task> findByProjectIdAndManagerId(
		long projectId, long managerId, int start, int end) {

		return getService().findByProjectIdAndManagerId(
