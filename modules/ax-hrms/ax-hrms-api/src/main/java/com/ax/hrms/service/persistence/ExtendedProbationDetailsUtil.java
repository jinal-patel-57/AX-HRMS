...
/**
 * The persistence utility for the extended probation details service. This utility wraps <code>com.ax.hrms.service.persistence.impl.ExtendedProbationDetailsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ExtendedProbationDetailsPersistence
 * @generated
 */
public class ExtendedProbationDetailsUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(extendedProbationDetails);
	}
	 ...
	 */
	public static Map<Serializable, ExtendedProbationDetails>
	 ...
	 */
	public static List<ExtendedProbationDetails> findWithDynamicQuery(
	 ...
	 */
	public static ExtendedProbationDetails update(
		ExtendedProbationDetails extendedProbationDetails) {

		return getPersistence().update(extendedProbationDetails);
	}
	...
	public static ExtendedProbationDetails update(
		...
		return getPersistence().update(
			extendedProbationDetails, serviceContext);
	}
	 ...
	 */
	public static List<ExtendedProbationDetails> findByUuid(String uuid) {
	 ...
	 */
	public static List<ExtendedProbationDetails> findByUuid(
	 ...
	 */
	public static ExtendedProbationDetails findByUuid_First(
			String uuid,
			OrderByComparator<ExtendedProbationDetails> orderByComparator)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {
	 ...
	 */
	public static ExtendedProbationDetails fetchByUuid_First(
		String uuid,
		OrderByComparator<ExtendedProbationDetails> orderByComparator) {
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a matching extended probation details could not be found
	 */
	public static ExtendedProbationDetails findByUuid_Last(
			String uuid,
			OrderByComparator<ExtendedProbationDetails> orderByComparator)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {
	 ...
	 */
	public static ExtendedProbationDetails fetchByUuid_Last(
		String uuid,
		OrderByComparator<ExtendedProbationDetails> orderByComparator) {
	 ...
	 */
	public static ExtendedProbationDetails[] findByUuid_PrevAndNext(
			long extendedProbationDetailsId, String uuid,
			OrderByComparator<ExtendedProbationDetails> orderByComparator)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {

		return getPersistence().findByUuid_PrevAndNext(
			extendedProbationDetailsId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a matching extended probation details could not be found
	 */
	public static ExtendedProbationDetails findByUUID_G(
	 ...
	 */
	public static ExtendedProbationDetails fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static ExtendedProbationDetails removeByUUID_G(
			String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {
	 ...
	 * @return the matching extended probation detailses
	 */
	public static List<ExtendedProbationDetails> findByUuid_C(
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a matching extended probation details could not be found
	 */
	public static ExtendedProbationDetails findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<ExtendedProbationDetails> orderByComparator)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {
	 ...
	 * @return the first matching extended probation details, or <code>null</code> if a matching extended probation details could not be found
	 */
	public static ExtendedProbationDetails fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<ExtendedProbationDetails> orderByComparator) {
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a matching extended probation details could not be found
	 */
	public static ExtendedProbationDetails findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<ExtendedProbationDetails> orderByComparator)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {
	 ...
	 * @return the last matching extended probation details, or <code>null</code> if a matching extended probation details could not be found
	 */
	public static ExtendedProbationDetails fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<ExtendedProbationDetails> orderByComparator) {
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a extended probation details with the primary key could not be found
	 */
	public static ExtendedProbationDetails[] findByUuid_C_PrevAndNext(
			long extendedProbationDetailsId, String uuid, long companyId,
			OrderByComparator<ExtendedProbationDetails> orderByComparator)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {

		return getPersistence().findByUuid_C_PrevAndNext(
			extendedProbationDetailsId, uuid, companyId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(extendedProbationDetails);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(extendedProbationDetailses);
	}
	 ...
	 */
	public static ExtendedProbationDetails create(
		long extendedProbationDetailsId) {

		return getPersistence().create(extendedProbationDetailsId);
	}
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a extended probation details with the primary key could not be found
	 */
	public static ExtendedProbationDetails remove(
			long extendedProbationDetailsId)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {

		return getPersistence().remove(extendedProbationDetailsId);
	}

	public static ExtendedProbationDetails updateImpl(
		ExtendedProbationDetails extendedProbationDetails) {

		return getPersistence().updateImpl(extendedProbationDetails);
	}
	 ...
	 * @throws NoSuchExtendedProbationDetailsException if a extended probation details with the primary key could not be found
	 */
	public static ExtendedProbationDetails findByPrimaryKey(
			long extendedProbationDetailsId)
		throws com.ax.hrms.exception.NoSuchExtendedProbationDetailsException {

		return getPersistence().findByPrimaryKey(extendedProbationDetailsId);
	}
	 ...
	 */
	public static ExtendedProbationDetails fetchByPrimaryKey(
		long extendedProbationDetailsId) {

		return getPersistence().fetchByPrimaryKey(extendedProbationDetailsId);
	}
	 ...
	 */
	public static List<ExtendedProbationDetails> findAll() {
	 ...
	 */
	public static List<ExtendedProbationDetails> findAll(int start, int end) {
	...
	public static ExtendedProbationDetailsPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		ExtendedProbationDetailsPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile ExtendedProbationDetailsPersistence _persistence;
