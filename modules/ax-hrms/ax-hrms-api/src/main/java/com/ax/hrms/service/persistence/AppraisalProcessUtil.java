...
/**
 * The persistence utility for the appraisal process service. This utility wraps <code>com.ax.hrms.service.persistence.impl.AppraisalProcessPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AppraisalProcessPersistence
 * @generated
 */
public class AppraisalProcessUtil {
	 ...
	 */
	public static void clearCache(AppraisalProcess appraisalProcess) {
		getPersistence().clearCache(appraisalProcess);
	}
	 ...
	 */
	public static Map<Serializable, AppraisalProcess> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AppraisalProcess> findWithDynamicQuery(
	 ...
	 */
	public static AppraisalProcess update(AppraisalProcess appraisalProcess) {
		return getPersistence().update(appraisalProcess);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static AppraisalProcess update(
		AppraisalProcess appraisalProcess, ServiceContext serviceContext) {

		return getPersistence().update(appraisalProcess, serviceContext);
	}
	 ...
	 */
	public static List<AppraisalProcess> findByUuid(String uuid) {
	 ...
	 */
	public static List<AppraisalProcess> findByUuid(
	 ...
	 */
	public static AppraisalProcess findByUuid_First(
			String uuid, OrderByComparator<AppraisalProcess> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {
	 ...
	 */
	public static AppraisalProcess fetchByUuid_First(
		String uuid, OrderByComparator<AppraisalProcess> orderByComparator) {
	 ...
	 * @throws NoSuchAppraisalProcessException if a matching appraisal process could not be found
	 */
	public static AppraisalProcess findByUuid_Last(
			String uuid, OrderByComparator<AppraisalProcess> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {
	 ...
	 */
	public static AppraisalProcess fetchByUuid_Last(
		String uuid, OrderByComparator<AppraisalProcess> orderByComparator) {
	 ...
	 */
	public static AppraisalProcess[] findByUuid_PrevAndNext(
			long appraisalProcessId, String uuid,
			OrderByComparator<AppraisalProcess> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {

		return getPersistence().findByUuid_PrevAndNext(
			appraisalProcessId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAppraisalProcessException if a matching appraisal process could not be found
	 */
	public static AppraisalProcess findByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {
	 ...
	 */
	public static AppraisalProcess fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching appraisal process, or <code>null</code> if a matching appraisal process could not be found
	 */
	public static AppraisalProcess fetchByUUID_G(
	 ...
	 */
	public static AppraisalProcess removeByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {
	 ...
	 * @return the matching appraisal processes
	 */
	public static List<AppraisalProcess> findByUuid_C(
	 ...
	 * @throws NoSuchAppraisalProcessException if a matching appraisal process could not be found
	 */
	public static AppraisalProcess findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AppraisalProcess> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {
	 ...
	 * @return the first matching appraisal process, or <code>null</code> if a matching appraisal process could not be found
	 */
	public static AppraisalProcess fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AppraisalProcess> orderByComparator) {
	 ...
	 * @throws NoSuchAppraisalProcessException if a matching appraisal process could not be found
	 */
	public static AppraisalProcess findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AppraisalProcess> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {
	 ...
	 * @return the last matching appraisal process, or <code>null</code> if a matching appraisal process could not be found
	 */
	public static AppraisalProcess fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AppraisalProcess> orderByComparator) {
	 ...
	 * @throws NoSuchAppraisalProcessException if a appraisal process with the primary key could not be found
	 */
	public static AppraisalProcess[] findByUuid_C_PrevAndNext(
			long appraisalProcessId, String uuid, long companyId,
			OrderByComparator<AppraisalProcess> orderByComparator)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {

		return getPersistence().findByUuid_C_PrevAndNext(
			appraisalProcessId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(AppraisalProcess appraisalProcess) {
		getPersistence().cacheResult(appraisalProcess);
	}
	 ...
	 */
	public static void cacheResult(List<AppraisalProcess> appraisalProcesses) {
		getPersistence().cacheResult(appraisalProcesses);
	}
	 ...
	 */
	public static AppraisalProcess create(long appraisalProcessId) {
		return getPersistence().create(appraisalProcessId);
	}
	 ...
	 * @throws NoSuchAppraisalProcessException if a appraisal process with the primary key could not be found
	 */
	public static AppraisalProcess remove(long appraisalProcessId)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {

		return getPersistence().remove(appraisalProcessId);
	}

	public static AppraisalProcess updateImpl(
		AppraisalProcess appraisalProcess) {

		return getPersistence().updateImpl(appraisalProcess);
	}
	 ...
	 * @throws NoSuchAppraisalProcessException if a appraisal process with the primary key could not be found
	 */
	public static AppraisalProcess findByPrimaryKey(long appraisalProcessId)
		throws com.ax.hrms.exception.NoSuchAppraisalProcessException {

		return getPersistence().findByPrimaryKey(appraisalProcessId);
	}
	 ...
	 */
	public static AppraisalProcess fetchByPrimaryKey(long appraisalProcessId) {
		return getPersistence().fetchByPrimaryKey(appraisalProcessId);
	}
	 ...
	 */
	public static List<AppraisalProcess> findAll() {
	 ...
	 */
	public static List<AppraisalProcess> findAll(int start, int end) {
	...
	public static AppraisalProcessPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(AppraisalProcessPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile AppraisalProcessPersistence _persistence;
