 ...
 * <code>com.ax.hrms.service.impl.CommentLocalServiceImpl</code> and
...
public class CommentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.service.impl.CommentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Comment> findByRequestIdAndStatus(
		...
		return getService().findByRequestIdAndStatus(requestId, status);
	}
	...
	public static List<Comment> findByTypeActionRequestIdAndStatus(
		...
		return getService().findByTypeActionRequestIdAndStatus(
	...
	public static List<Comment> findByTypeRequestIdAndStatus(
		...
		return getService().findByTypeRequestIdAndStatus(
	...
	private static final Snapshot<CommentLocalService> _serviceSnapshot =
		new Snapshot<>(
			CommentLocalServiceUtil.class, CommentLocalService.class);
