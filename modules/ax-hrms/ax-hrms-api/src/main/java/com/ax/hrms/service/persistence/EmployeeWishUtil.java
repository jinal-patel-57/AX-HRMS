 ...
 * @see EmployeeWishPersistence
 * @generated
 */
public class EmployeeWishUtil {
	 ...
	 */
	public static void clearCache(EmployeeWish employeeWish) {
		getPersistence().clearCache(employeeWish);
	}
	 ...
	 */
	public static Map<Serializable, EmployeeWish> fetchByPrimaryKeys(
	 ...
	 */
	public static List<EmployeeWish> findWithDynamicQuery(
	 ...
	 */
	public static EmployeeWish update(EmployeeWish employeeWish) {
		return getPersistence().update(employeeWish);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static EmployeeWish update(
		EmployeeWish employeeWish, ServiceContext serviceContext) {

		return getPersistence().update(employeeWish, serviceContext);
	}
	 ...
	 */
	public static List<EmployeeWish> findByUuid(String uuid) {
	 ...
	 */
	public static List<EmployeeWish> findByUuid(
	 ...
	 */
	public static EmployeeWish findByUuid_First(
			String uuid, OrderByComparator<EmployeeWish> orderByComparator)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {
	 ...
	 */
	public static EmployeeWish fetchByUuid_First(
		String uuid, OrderByComparator<EmployeeWish> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeWishException if a matching employee wish could not be found
	 */
	public static EmployeeWish findByUuid_Last(
			String uuid, OrderByComparator<EmployeeWish> orderByComparator)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {
	 ...
	 */
	public static EmployeeWish fetchByUuid_Last(
		String uuid, OrderByComparator<EmployeeWish> orderByComparator) {
	 ...
	 */
	public static EmployeeWish[] findByUuid_PrevAndNext(
			long wishId, String uuid,
			OrderByComparator<EmployeeWish> orderByComparator)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {

		return getPersistence().findByUuid_PrevAndNext(
			wishId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchEmployeeWishException if a matching employee wish could not be found
	 */
	public static EmployeeWish findByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {
	 ...
	 */
	public static EmployeeWish fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching employee wish, or <code>null</code> if a matching employee wish could not be found
	 */
	public static EmployeeWish fetchByUUID_G(
	 ...
	 */
	public static EmployeeWish removeByUUID_G(String uuid, long groupId)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {
	 ...
	 * @return the matching employee wishes
	 */
	public static List<EmployeeWish> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching employee wishes
	 */
	public static List<EmployeeWish> findByUuid_C(
	 ...
	 * @throws NoSuchEmployeeWishException if a matching employee wish could not be found
	 */
	public static EmployeeWish findByUuid_C_First(
	 ...
	 * @return the first matching employee wish, or <code>null</code> if a matching employee wish could not be found
	 */
	public static EmployeeWish fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<EmployeeWish> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeWishException if a matching employee wish could not be found
	 */
	public static EmployeeWish findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<EmployeeWish> orderByComparator)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {
	 ...
	 * @return the last matching employee wish, or <code>null</code> if a matching employee wish could not be found
	 */
	public static EmployeeWish fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<EmployeeWish> orderByComparator) {
	 ...
	 * @throws NoSuchEmployeeWishException if a employee wish with the primary key could not be found
	 */
	public static EmployeeWish[] findByUuid_C_PrevAndNext(
			long wishId, String uuid, long companyId,
			OrderByComparator<EmployeeWish> orderByComparator)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {

		return getPersistence().findByUuid_C_PrevAndNext(
			wishId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(EmployeeWish employeeWish) {
		getPersistence().cacheResult(employeeWish);
	}
	 ...
	 */
	public static void cacheResult(List<EmployeeWish> employeeWishes) {
		getPersistence().cacheResult(employeeWishes);
	}
	 ...
	 */
	public static EmployeeWish create(long wishId) {
	 ...
	 * @throws NoSuchEmployeeWishException if a employee wish with the primary key could not be found
	 */
	public static EmployeeWish remove(long wishId)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {

		return getPersistence().remove(wishId);
	}

	public static EmployeeWish updateImpl(EmployeeWish employeeWish) {
		return getPersistence().updateImpl(employeeWish);
	}
	 ...
	 * @throws NoSuchEmployeeWishException if a employee wish with the primary key could not be found
	 */
	public static EmployeeWish findByPrimaryKey(long wishId)
		throws com.ax.hrms.exception.NoSuchEmployeeWishException {
	 ...
	 */
	public static EmployeeWish fetchByPrimaryKey(long wishId) {
	 ...
	 */
	public static List<EmployeeWish> findAll() {
	 ...
	 */
	public static List<EmployeeWish> findAll(int start, int end) {
	...
	public static EmployeeWishPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(EmployeeWishPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile EmployeeWishPersistence _persistence;
