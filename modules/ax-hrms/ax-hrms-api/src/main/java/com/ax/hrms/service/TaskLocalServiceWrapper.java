...
public class TaskLocalServiceWrapper
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task addTask(com.ax.hrms.model.Task task) {
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task createTask(long taskId) {
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task deleteTask(com.ax.hrms.model.Task task) {
	...
	@Override
	public com.ax.hrms.model.Task fetchTask(long taskId) {
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task fetchTaskByUuidAndGroupId(
	...
	@Override
	public java.util.List<com.ax.hrms.model.Task> findByAssignedTo(
		long assignedTo) {

		return _taskLocalService.findByAssignedTo(assignedTo);
	}

	@Override
	public java.util.List<com.ax.hrms.model.Task> findByManagerId(
		long managerId) {

		return _taskLocalService.findByManagerId(managerId);
	}

	@Override
	public java.util.List<com.ax.hrms.model.Task> findByProjectId(
		long projectId) {

		return _taskLocalService.findByProjectId(projectId);
	}
	...
	public java.util.List<com.ax.hrms.model.Task> findByProjectId(
		...
		return _taskLocalService.findByProjectId(projectId, start, end);
	}

	@Override
	public java.util.List<com.ax.hrms.model.Task> findByProjectIdAndAssigneeId(
		long projectId, long assignedTo) {

		return _taskLocalService.findByProjectIdAndAssigneeId(
	...
	@Override
	public java.util.List<com.ax.hrms.model.Task> findByProjectIdAndManagerId(
		long projectId, long managerId) {

		return _taskLocalService.findByProjectIdAndManagerId(
			projectId, managerId);
	}
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task getTaskByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.ax.hrms.model.Task> getTasks(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<com.ax.hrms.model.Task> getTasksByUuidAndCompanyId(
	...
	public java.util.List<com.ax.hrms.model.Task> getTasksByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.ax.hrms.model.Task>
			orderByComparator) {
	 ...
	 */
	@Override
	public com.ax.hrms.model.Task updateTask(com.ax.hrms.model.Task task) {
