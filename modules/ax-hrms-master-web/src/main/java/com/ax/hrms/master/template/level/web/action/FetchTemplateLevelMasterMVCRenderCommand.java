...
@Component(
        property = {
                ...
                "mvc.command.name=/fetchTemplateLevelMaster"
        },
        service = MVCRenderCommand.class
)
public class FetchTemplateLevelMasterMVCRenderCommand implements MVCRenderCommand {
    ...
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        ...
        return AxHrmsTemplateLevelMasterConstants.TEMPLATE_LEVEL_MASTER_FORM_JSP;
    }
}
