...
@Component(
        property = {
                ...
                "mvc.command.name=/fetchAppraisalStatusMaster"
        },
        service = MVCRenderCommand.class
)
public class FetchAppraisalStatusMasterMVCRenderCommand implements MVCRenderCommand {
    ...
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        ...
        return AxHrmsAppraisalStatusMasterConstants.APPRAISAL_STATUS_MASTER_FORM_JSP;
    }
}
