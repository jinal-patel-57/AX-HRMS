...
@Component(
        property = {
                ...
                "mvc.command.name=/fetchProjectTaskStatusMaster"
        },
        service = MVCRenderCommand.class
)
public class FetchProjectTaskStatusMasterMVCRenderCommand implements MVCRenderCommand {
    ...
    public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
        ...
        return AxHrmsProjectTaskStatusMasterConstants.PROJECT_TASK_STATUS_MASTER_FORM_JSP;
    }
}
