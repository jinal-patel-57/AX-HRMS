...
public class LoginMVCActionCommandOverride extends BaseMVCActionCommand {
		...
		try {
			...
			if (exception instanceof AuthException) {
				...
				if (!company.isSendPasswordResetLink()) {
					...
					String emailFromName = ((javax.portlet.PortletPreferences) portletPreferences).getValue(
						"emailFromName", null);
					String emailFromAddress = ((javax.portlet.PortletPreferences) portletPreferences).getValue(
					...
					UserLocalServiceUtil.sendPasswordLockout(
							company.getCompanyId(), emailToAddress, emailFromName, emailFromAddress, null,
							null, serviceContext);
	...
	private User _getUser(ActionRequest actionRequest) throws Exception {
		...
		PortletPreferences portletPreferences = (PortletPreferences) actionRequest.getPreferences();

		String authType = ((javax.portlet.PortletPreferences) portletPreferences).getValue("authType", null);
	...
	private static final Log _log = LogFactoryUtil.getLog(
			LoginMVCActionCommandOverride.class);
