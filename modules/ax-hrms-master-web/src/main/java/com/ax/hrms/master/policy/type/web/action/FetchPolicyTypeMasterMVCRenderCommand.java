...
@Component(
		...
		property = {
			...
			"mvc.command.name=/fetchPolicyType"
		},
		service = MVCRenderCommand.class
	)

public class FetchPolicyTypeMasterMVCRenderCommand implements MVCRenderCommand {
	
	private Log log = LogFactoryUtil.getLog(FetchPolicyTypeMasterMVCRenderCommand.class);
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		try {
			...
			renderRequest.setAttribute(AxPolicyTypeMasterWebPortletConstants.POLICYTYPE_MASTER_DATA, policyTypeMasterLocalService.getPolicyTypeMaster(policyTypeMasterId));
		...
		return AxPolicyTypeMasterWebPortletConstants.FORM_POLICY_TYPE_MASTER;
	}
