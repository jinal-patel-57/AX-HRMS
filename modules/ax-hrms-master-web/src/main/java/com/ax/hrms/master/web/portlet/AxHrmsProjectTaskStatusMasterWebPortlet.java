...
@Component(
	...
	property = {
		...
		"com.liferay.portlet.header-portlet-javascript=/js/project-task-status-master/main.js",
		"javax.portlet.display-name=Ax Hrms Project Task Status Master",
...
public class AxHrmsProjectTaskStatusMasterWebPortlet extends MVCPortlet {
