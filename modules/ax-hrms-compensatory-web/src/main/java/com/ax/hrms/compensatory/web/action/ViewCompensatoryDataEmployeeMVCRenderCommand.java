...
public class ViewCompensatoryDataEmployeeMVCRenderCommand implements MVCRenderCommand {
    ...
    private static final Log log = LogFactoryUtil.getLog(ViewCompensatoryDataEmployeeMVCRenderCommand.class);
...
//            compensatoryDataDto.setRequestedHours(compensatoryData.getRequestedHours());
            ...
            log.error("Error in render command :: " + e.getMessage(), e);
        }
