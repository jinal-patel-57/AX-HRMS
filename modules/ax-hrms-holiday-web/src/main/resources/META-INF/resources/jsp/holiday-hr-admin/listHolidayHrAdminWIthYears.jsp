        ...
        <liferay-ui:search-container-column-text name="Actions" cssClass="text-center">
          ...
          <portlet:renderURL var="updateHolidayURL">
					...
					<ul class="dropdown-menu">
						...
						<li>
						<a onclick="openDeleteHolidayModal('${holiday.holidayId}', '${holiday.holidayName}')" class=" dropdown-item ${btnClass}"><i class="icon-trash"></i> <liferay-ui:message
						key="delete" /></a>
						</li>
					</ul>
				</div>
...
// Store selected holiday
var selectedHolidayId = null;

// Open Modal
function openDeleteHolidayModal(holidayId, holidayName) {
    selectedHolidayId = holidayId;

    // Dynamic message
    document.getElementById("holidayDeleteMessage").innerText =
