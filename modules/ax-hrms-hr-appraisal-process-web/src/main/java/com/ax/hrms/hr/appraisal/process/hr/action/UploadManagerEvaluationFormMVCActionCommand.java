...
@Component(
        property = {
                ...
                "mvc.command.name=/uploadManagerEvaluationForm"
        },
        service = MVCActionCommand.class
)
public class UploadManagerEvaluationFormMVCActionCommand extends BaseMVCActionCommand {
    ...
    protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        ...
        Folder folder = folderNavigatorForManagerAppraisalFileUpload(appraisalEvaluationFormStatusId, themeDisplay, serviceContext);
        ...
        sendManagerFormFilledNotificationToHrAdmin(entry,employeeDetails,reviewerEmployeeDetails);
    ...
    private void sendManagerFormFilledNotificationToHrAdmin(FileEntry entry, EmployeeDetails employeeDetails, EmployeeDetails reviewerEmployeeDetails) throws PortalException {
        ...
        String htmlBody = "<body style=\"font-family: Arial, sans-serif; line-height: 1.6; background-color: #f4f4f4; padding: 20px; margin: 0;\">" +
                ...
                "<h2 style=\"color: #333;\">New Manager Evaluation Form Submitted</h2>" +
                "<p style=\"margin-bottom: 20px; color: #666;\">Hello HR Team,</p>" +
                "<p style=\"margin-bottom: 10px;\">A new manager-evaluation form has been submitted for the appraisal process. Below are the details:</p>" +
                ...
                "<tr>" +
                "<tr>" +
                "<td style=\"padding: 8px; background-color: #f2f2f2; border: 1px solid #ddd;\">Reviewer Manager Name</td>" +
        ...
        for (User hrUser : hrUsers) {
            axHrmsCommonApi.sendMailWithAttachment(
                    ...
                    fromEmailAddress,
                    fromName,
                    "NEW MANAGER APPRAISAL FORM UPLOADED",
                    htmlBody,
                    file,
                    entry.getFileName()
            );
    ...
    private Folder folderNavigatorForManagerAppraisalFileUpload(long appraisalEvaluationFormStatusId, ThemeDisplay themeDisplay, ServiceContext serviceContext) throws PortalException {
        Folder folder = null;
        ...
        EmployeeDetails managerEmployeeDetails = employeeDetailsLocalService.getEmployeeDetails(appraisalEvaluationFormStatusLocalService.getAppraisalEvaluationFormStatus(appraisalEvaluationFormStatusId).getEmployeeId());
        ...
        String managerFolderName = managerEmployeeDetails.getFirstName() + AxHrmsHrAppraisalProcessHrConstants.HYPHEN + managerEmployeeDetails.getLastName();
        ...
        folder = axHrmsCommonApi.createFolder(AxHrmsHrAppraisalProcessHrConstants.MANAGER_CAPITAL,folder.getFolderId(),themeDisplay,serviceContext);
        folder = axHrmsCommonApi.createFolder(managerFolderName,folder.getFolderId(),themeDisplay,serviceContext);
