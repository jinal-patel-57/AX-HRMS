...
<portlet:actionURL var="uploadPeerEvaluationFormURL" name="/uploadPeerEvaluationForm" />
<div class="card">
    <div class="card-header">
        <strong>Peer Evaluation Form Submission Panel</strong>
    </div>
    ...
    <c:if test="${isEmployeeValid}">
        <form action="${uploadPeerEvaluationFormURL}" id="selfForm" method="post"
              enctype="multipart/form-data">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="form-group-view">
                            <div class="label-name">Employee under review Name</div>
                            <div class="label-content">${appraisee}</div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="form-group-view">
                            <div class="label-name">Peer Reviewer Name</div>
                            <div class="label-content">${peerName}</div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="form-group-view">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="form-group-view">
                            <label for="formFile" class="label-name">Upload Peer Evaluation Form<span class="text-danger">*</span></label>
