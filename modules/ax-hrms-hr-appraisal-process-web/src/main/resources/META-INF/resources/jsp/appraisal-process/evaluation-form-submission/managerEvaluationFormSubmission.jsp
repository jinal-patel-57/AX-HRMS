...
<portlet:actionURL var="uploadManagerEvaluationFormURL" name="/uploadManagerEvaluationForm"/>


<div class="card">
    <div class="card-header">
        <strong>Manager Evaluation Form Submission Panel</strong>
    </div>
    ...
    <c:if test="${isEmployeeValid}">
        <form action="${uploadManagerEvaluationFormURL}" id="selfForm" method="post"
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="form-group-view">
                            <div class="label-name">Manager Reviewer Name</div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="form-group-view">
                            <label for="formFile" class="label-name">Upload Manager Evaluation Form <span class="text-danger">*</span></label>
