<%@ include file="/init.jsp" %>
    ...
    <div class="card">
        ...
        <form action="${employeeOffBoardingHrURL}" method="post" enctype="multipart/form-data" data-senna="off"
            id="offBoardFm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label" for="checkbox4"><liferay-ui:message
                                        key='plum' /></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="fileUpload1"><liferay-ui:message key='exp-letter' /><span
                            ...
                            <small class="form-text text-muted">
                                Allowed file types: PDF, JPG, PNG, JPEG. Max file size: 10MB
                            </small>
                        </div>
                        <div class="form-group">
                            <label for="fileUpload2"><liferay-ui:message key='rel-letter' /><span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="fileUpload3"><liferay-ui:message key='full-final-letter' /><span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control file-upload" id="fileUpload3" disabled rows="4"
                                maxlength="500" name="<portlet:namespace/>fullAndFinal"
                                placeholder="Maximum 500 characters">${fullAndFinalLetterFileName}</textarea>
            ...
            <div class="card-footer text-right align-items-center">
                ...
                <button type="submit" class="btn btn-outline-success" name="<portlet:namespace/>offBoard"
                    value="offBoard" id="offBoardBtn" disabled><liferay-ui:message key='off-board' /></button>
