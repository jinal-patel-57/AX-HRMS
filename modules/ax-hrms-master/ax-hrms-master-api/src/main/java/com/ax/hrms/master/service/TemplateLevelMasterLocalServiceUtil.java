...
/**
 * Provides the local service utility for TemplateLevelMaster. This utility wraps
 * <code>com.ax.hrms.master.service.impl.TemplateLevelMasterLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TemplateLevelMasterLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.master.service.impl.TemplateLevelMasterLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TemplateLevelMaster addTemplateLevelMaster(
		TemplateLevelMaster templateLevelMaster) {

		return getService().addTemplateLevelMaster(templateLevelMaster);
	}
	 ...
	 */
	public static TemplateLevelMaster createTemplateLevelMaster(
		long templateLevelMasterId) {

		return getService().createTemplateLevelMaster(templateLevelMasterId);
	}
	 ...
	 */
	public static TemplateLevelMaster deleteTemplateLevelMaster(
			long templateLevelMasterId)
		throws PortalException {

		return getService().deleteTemplateLevelMaster(templateLevelMasterId);
	}
	...
	public static TemplateLevelMaster deleteTemplateLevelMaster(
		...
		return getService().deleteTemplateLevelMaster(templateLevelMaster);
	}
	...
	public static TemplateLevelMaster fetchTemplateLevelMaster(
		long templateLevelMasterId) {

		return getService().fetchTemplateLevelMaster(templateLevelMasterId);
	}
	 ...
	 * @throws PortalException if a template level master with the primary key could not be found
	 */
	public static TemplateLevelMaster getTemplateLevelMaster(
			long templateLevelMasterId)
		throws PortalException {

		return getService().getTemplateLevelMaster(templateLevelMasterId);
	}
	 ...
	 */
	public static List<TemplateLevelMaster> getTemplateLevelMasters(
		int start, int end) {

		return getService().getTemplateLevelMasters(start, end);
	}
	 ...
	 */
	public static int getTemplateLevelMastersCount() {
		return getService().getTemplateLevelMastersCount();
	}
	 ...
	 */
	public static TemplateLevelMaster updateTemplateLevelMaster(
		TemplateLevelMaster templateLevelMaster) {

		return getService().updateTemplateLevelMaster(templateLevelMaster);
	}

	public static TemplateLevelMasterLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TemplateLevelMasterLocalService>
		_serviceSnapshot = new Snapshot<>(
			TemplateLevelMasterLocalServiceUtil.class,
			TemplateLevelMasterLocalService.class);
