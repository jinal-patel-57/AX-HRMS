...
/**
 * The base model interface for the ProjectTaskStatusMaster service. Represents a row in the &quot;ax_master_ProjectTaskStatusMaster&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.ax.hrms.master.model.impl.ProjectTaskStatusMasterModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.ax.hrms.master.model.impl.ProjectTaskStatusMasterImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface ProjectTaskStatusMasterModel
	extends BaseModel<ProjectTaskStatusMaster>, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a project task status master model instance should use the {@link ProjectTaskStatusMaster} interface instead.
	 */
