...
/**
 * Provides the local service utility for BranchMaster. This utility wraps
 * <code>com.ax.hrms.master.service.impl.BranchMasterLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BranchMasterLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.master.service.impl.BranchMasterLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static BranchMaster addBranchMaster(BranchMaster branchMaster) {
		return getService().addBranchMaster(branchMaster);
	}
	 ...
	 */
	public static BranchMaster createBranchMaster(long branchMasterId) {
		return getService().createBranchMaster(branchMasterId);
	}
	 ...
	 */
	public static BranchMaster deleteBranchMaster(BranchMaster branchMaster) {
		return getService().deleteBranchMaster(branchMaster);
	}
	 ...
	 */
	public static BranchMaster deleteBranchMaster(long branchMasterId)
		throws PortalException {

		return getService().deleteBranchMaster(branchMasterId);
	}
	...
	public static BranchMaster fetchBranchMaster(long branchMasterId) {
		return getService().fetchBranchMaster(branchMasterId);
	}
	 ...
	 * @throws PortalException if a branch master with the primary key could not be found
	 */
	public static BranchMaster getBranchMaster(long branchMasterId)
		throws PortalException {

		return getService().getBranchMaster(branchMasterId);
	}
	 ...
	 */
	public static List<BranchMaster> getBranchMasters(int start, int end) {
		return getService().getBranchMasters(start, end);
	}
	 ...
	 */
	public static int getBranchMastersCount() {
		return getService().getBranchMastersCount();
	}
	 ...
	 */
	public static BranchMaster updateBranchMaster(BranchMaster branchMaster) {
		return getService().updateBranchMaster(branchMaster);
	}

	public static BranchMasterLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<BranchMasterLocalService> _serviceSnapshot =
		new Snapshot<>(
			BranchMasterLocalServiceUtil.class, BranchMasterLocalService.class);
