...
/**
 * Provides the local service interface for EducationLevelMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EducationLevelMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EducationLevelMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ax.hrms.master.service.impl.EducationLevelMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the education level master local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EducationLevelMasterLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public EducationLevelMaster addEducationLevelMaster(
	...
	public EducationLevelMaster createEducationLevelMaster(
	...
	public EducationLevelMaster deleteEducationLevelMaster(
		EducationLevelMaster educationLevelMaster);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EducationLevelMaster fetchEducationLevelMaster(
		long educationLevelMasterId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EducationLevelMaster getEducationLevelMaster(
			long educationLevelMasterId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EducationLevelMaster> getEducationLevelMasters(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EducationLevelMaster updateEducationLevelMaster(
		EducationLevelMaster educationLevelMaster);
