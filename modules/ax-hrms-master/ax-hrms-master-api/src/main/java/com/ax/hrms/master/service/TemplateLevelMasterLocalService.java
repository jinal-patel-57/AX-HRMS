...
/**
 * Provides the local service interface for TemplateLevelMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TemplateLevelMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TemplateLevelMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ax.hrms.master.service.impl.TemplateLevelMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the template level master local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TemplateLevelMasterLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TemplateLevelMaster addTemplateLevelMaster(
	...
	public TemplateLevelMaster createTemplateLevelMaster(
	...
	public TemplateLevelMaster deleteTemplateLevelMaster(
			long templateLevelMasterId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TemplateLevelMaster fetchTemplateLevelMaster(
		long templateLevelMasterId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TemplateLevelMaster getTemplateLevelMaster(
			long templateLevelMasterId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TemplateLevelMaster> getTemplateLevelMasters(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TemplateLevelMaster updateTemplateLevelMaster(
		TemplateLevelMaster templateLevelMaster);
