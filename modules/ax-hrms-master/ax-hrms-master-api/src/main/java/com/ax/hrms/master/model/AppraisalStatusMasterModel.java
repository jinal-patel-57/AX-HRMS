...
/**
 * The base model interface for the AppraisalStatusMaster service. Represents a row in the &quot;ax_master_AppraisalStatusMaster&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.ax.hrms.master.model.impl.AppraisalStatusMasterModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.ax.hrms.master.model.impl.AppraisalStatusMasterImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface AppraisalStatusMasterModel
	extends BaseModel<AppraisalStatusMaster>, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a appraisal status master model instance should use the {@link AppraisalStatusMaster} interface instead.
	 */
