...
/**
 * The persistence utility for the leave type master service. This utility wraps <code>com.ax.hrms.master.service.persistence.impl.LeaveTypeMasterPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LeaveTypeMasterPersistence
 * @generated
 */
public class LeaveTypeMasterUtil {
	 ...
	 */
	public static void clearCache(LeaveTypeMaster leaveTypeMaster) {
		getPersistence().clearCache(leaveTypeMaster);
	}
	 ...
	 */
	public static Map<Serializable, LeaveTypeMaster> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LeaveTypeMaster> findWithDynamicQuery(
	 ...
	 */
	public static LeaveTypeMaster update(LeaveTypeMaster leaveTypeMaster) {
		return getPersistence().update(leaveTypeMaster);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static LeaveTypeMaster update(
		LeaveTypeMaster leaveTypeMaster, ServiceContext serviceContext) {

		return getPersistence().update(leaveTypeMaster, serviceContext);
	}
	 ...
	 */
	public static LeaveTypeMaster fetchByLeaveTypeName(String leaveTypeName) {
	 ...
	 * @return the matching leave type master, or <code>null</code> if a matching leave type master could not be found
	 */
	public static LeaveTypeMaster fetchByLeaveTypeName(
		String leaveTypeName, boolean useFinderCache) {

		return getPersistence().fetchByLeaveTypeName(
			leaveTypeName, useFinderCache);
	}
	 ...
	 */
	public static LeaveTypeMaster removeByLeaveTypeName(String leaveTypeName)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {
	 ...
	 */
	public static int countByLeaveTypeName(String leaveTypeName) {
	 ...
	 * @return the matching leave type master, or <code>null</code> if a matching leave type master could not be found
	 */
	public static LeaveTypeMaster fetchByLeaveTypeMasterId(
		long leaveTypeMasterId) {
	 ...
	 * @return the leave type master that was removed
	 */
	public static LeaveTypeMaster removeByLeaveTypeMasterId(
			long leaveTypeMasterId)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {
	...
	public static List<LeaveTypeMaster> findByActiveAndAppearForAll(
		...
		return getPersistence().findByActiveAndAppearForAll(
	...
	public static List<LeaveTypeMaster> findByActiveAndAppearForAll(
		...
		return getPersistence().findByActiveAndAppearForAll(
			isActive, isAppearForAll, start, end);
	}
	 ...
	 * @throws NoSuchLeaveTypeMasterException if a matching leave type master could not be found
	 */
	public static LeaveTypeMaster findByActiveAndAppearForAll_First(
			boolean isActive, boolean isAppearForAll,
			OrderByComparator<LeaveTypeMaster> orderByComparator)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {

		return getPersistence().findByActiveAndAppearForAll_First(
	 ...
	 */
	public static LeaveTypeMaster fetchByActiveAndAppearForAll_First(
		boolean isActive, boolean isAppearForAll,
		OrderByComparator<LeaveTypeMaster> orderByComparator) {

		return getPersistence().fetchByActiveAndAppearForAll_First(
			isActive, isAppearForAll, orderByComparator);
	}
	 ...
	 * @throws NoSuchLeaveTypeMasterException if a matching leave type master could not be found
	 */
	public static LeaveTypeMaster findByActiveAndAppearForAll_Last(
			boolean isActive, boolean isAppearForAll,
			OrderByComparator<LeaveTypeMaster> orderByComparator)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {

		return getPersistence().findByActiveAndAppearForAll_Last(
			isActive, isAppearForAll, orderByComparator);
	}
	 ...
	 */
	public static LeaveTypeMaster fetchByActiveAndAppearForAll_Last(
		boolean isActive, boolean isAppearForAll,
		OrderByComparator<LeaveTypeMaster> orderByComparator) {

		return getPersistence().fetchByActiveAndAppearForAll_Last(
			isActive, isAppearForAll, orderByComparator);
	}
	 ...
	 */
	public static LeaveTypeMaster[] findByActiveAndAppearForAll_PrevAndNext(
			long leaveTypeMasterId, boolean isActive, boolean isAppearForAll,
			OrderByComparator<LeaveTypeMaster> orderByComparator)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {

		return getPersistence().findByActiveAndAppearForAll_PrevAndNext(
			leaveTypeMasterId, isActive, isAppearForAll, orderByComparator);
	}
	 ...
	 * @param isAppearForAll the is appear for all
	 */
	public static void removeByActiveAndAppearForAll(
		boolean isActive, boolean isAppearForAll) {

		getPersistence().removeByActiveAndAppearForAll(
			isActive, isAppearForAll);
	}
	 ...
	 * @return the number of matching leave type masters
	 */
	public static int countByActiveAndAppearForAll(
		boolean isActive, boolean isAppearForAll) {

		return getPersistence().countByActiveAndAppearForAll(
			isActive, isAppearForAll);
	}
	 ...
	 */
	public static void cacheResult(LeaveTypeMaster leaveTypeMaster) {
		getPersistence().cacheResult(leaveTypeMaster);
	}
	 ...
	 */
	public static void cacheResult(List<LeaveTypeMaster> leaveTypeMasters) {
		getPersistence().cacheResult(leaveTypeMasters);
	}
	 ...
	 */
	public static LeaveTypeMaster create(long leaveTypeMasterId) {
		return getPersistence().create(leaveTypeMasterId);
	}
	 ...
	 * @throws NoSuchLeaveTypeMasterException if a leave type master with the primary key could not be found
	 */
	public static LeaveTypeMaster remove(long leaveTypeMasterId)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {

		return getPersistence().remove(leaveTypeMasterId);
	}

	public static LeaveTypeMaster updateImpl(LeaveTypeMaster leaveTypeMaster) {
		return getPersistence().updateImpl(leaveTypeMaster);
	}
	 ...
	 * @throws NoSuchLeaveTypeMasterException if a leave type master with the primary key could not be found
	 */
	public static LeaveTypeMaster findByPrimaryKey(long leaveTypeMasterId)
		throws com.ax.hrms.master.exception.NoSuchLeaveTypeMasterException {

		return getPersistence().findByPrimaryKey(leaveTypeMasterId);
	}
	 ...
	 */
	public static LeaveTypeMaster fetchByPrimaryKey(long leaveTypeMasterId) {
		return getPersistence().fetchByPrimaryKey(leaveTypeMasterId);
	}
	 ...
	 */
	public static List<LeaveTypeMaster> findAll() {
	 ...
	 */
	public static List<LeaveTypeMaster> findAll(int start, int end) {
	...
	public static LeaveTypeMasterPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(LeaveTypeMasterPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile LeaveTypeMasterPersistence _persistence;
