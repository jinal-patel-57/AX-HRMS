...
/**
 * Provides the local service utility for WishTypeMaster. This utility wraps
 * <code>com.ax.hrms.master.service.impl.WishTypeMasterLocalServiceImpl</code> and
 ...
 * @generated
 */
public class WishTypeMasterLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ax.hrms.master.service.impl.WishTypeMasterLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static WishTypeMaster addWishTypeMaster(
		WishTypeMaster wishTypeMaster) {

		return getService().addWishTypeMaster(wishTypeMaster);
	}
	 ...
	 */
	public static WishTypeMaster createWishTypeMaster(long wishTypeMasterId) {
		return getService().createWishTypeMaster(wishTypeMasterId);
	}
	 ...
	 */
	public static WishTypeMaster deleteWishTypeMaster(long wishTypeMasterId)
		throws PortalException {

		return getService().deleteWishTypeMaster(wishTypeMasterId);
	}
	 ...
	 * @return the wish type master that was removed
	 */
	public static WishTypeMaster deleteWishTypeMaster(
		WishTypeMaster wishTypeMaster) {

		return getService().deleteWishTypeMaster(wishTypeMaster);
	}
	...
	public static WishTypeMaster fetchWishTypeMaster(long wishTypeMasterId) {
		return getService().fetchWishTypeMaster(wishTypeMasterId);
	}
	...
	public static WishTypeMaster findByWishType(String wishType)
		...
		return getService().findByWishType(wishType);
	}
	 ...
	 * @throws PortalException if a wish type master with the primary key could not be found
	 */
	public static WishTypeMaster getWishTypeMaster(long wishTypeMasterId)
		throws PortalException {

		return getService().getWishTypeMaster(wishTypeMasterId);
	}
	 ...
	 */
	public static List<WishTypeMaster> getWishTypeMasters(int start, int end) {
		return getService().getWishTypeMasters(start, end);
	}
	 ...
	 */
	public static int getWishTypeMastersCount() {
		return getService().getWishTypeMastersCount();
	}
	 ...
	 */
	public static WishTypeMaster updateWishTypeMaster(
		WishTypeMaster wishTypeMaster) {

		return getService().updateWishTypeMaster(wishTypeMaster);
	}

	public static WishTypeMasterLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<WishTypeMasterLocalService> _serviceSnapshot =
		new Snapshot<>(
			WishTypeMasterLocalServiceUtil.class,
			WishTypeMasterLocalService.class);
