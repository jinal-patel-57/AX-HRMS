...
public class DocumentTypeMasterUtil {
	 ...
	 */
	public static List<DocumentTypeMaster> findByIsDocumentUsedForKYC(
		boolean isDocumentUsedForKYC) {

		return getPersistence().findByIsDocumentUsedForKYC(
	...
	public static List<DocumentTypeMaster> findByIsDocumentUsedForKYC(
		...
		return getPersistence().findByIsDocumentUsedForKYC(
			isDocumentUsedForKYC, start, end);
	}
	 ...
	 * @throws NoSuchDocumentTypeMasterException if a matching document type master could not be found
	 */
	public static DocumentTypeMaster findByIsDocumentUsedForKYC_First(
			boolean isDocumentUsedForKYC,
			OrderByComparator<DocumentTypeMaster> orderByComparator)
		throws com.ax.hrms.master.exception.NoSuchDocumentTypeMasterException {

		return getPersistence().findByIsDocumentUsedForKYC_First(
	 ...
	 */
	public static DocumentTypeMaster fetchByIsDocumentUsedForKYC_First(
		boolean isDocumentUsedForKYC,
		OrderByComparator<DocumentTypeMaster> orderByComparator) {

		return getPersistence().fetchByIsDocumentUsedForKYC_First(
			isDocumentUsedForKYC, orderByComparator);
	}
	 ...
	 * @throws NoSuchDocumentTypeMasterException if a matching document type master could not be found
	 */
	public static DocumentTypeMaster findByIsDocumentUsedForKYC_Last(
			boolean isDocumentUsedForKYC,
			OrderByComparator<DocumentTypeMaster> orderByComparator)
		throws com.ax.hrms.master.exception.NoSuchDocumentTypeMasterException {

		return getPersistence().findByIsDocumentUsedForKYC_Last(
			isDocumentUsedForKYC, orderByComparator);
	}
	 ...
	 */
	public static DocumentTypeMaster fetchByIsDocumentUsedForKYC_Last(
		boolean isDocumentUsedForKYC,
		OrderByComparator<DocumentTypeMaster> orderByComparator) {

		return getPersistence().fetchByIsDocumentUsedForKYC_Last(
			isDocumentUsedForKYC, orderByComparator);
	}
	 ...
	 */
	public static DocumentTypeMaster[] findByIsDocumentUsedForKYC_PrevAndNext(
			long documentTypeMasterId, boolean isDocumentUsedForKYC,
			OrderByComparator<DocumentTypeMaster> orderByComparator)
		throws com.ax.hrms.master.exception.NoSuchDocumentTypeMasterException {

		return getPersistence().findByIsDocumentUsedForKYC_PrevAndNext(
			documentTypeMasterId, isDocumentUsedForKYC, orderByComparator);
	}
	 ...
	 * @param isDocumentUsedForKYC the is document used for kyc
	 */
	public static void removeByIsDocumentUsedForKYC(
		boolean isDocumentUsedForKYC) {

		getPersistence().removeByIsDocumentUsedForKYC(isDocumentUsedForKYC);
	}
	 ...
	 * @return the number of matching document type masters
	 */
	public static int countByIsDocumentUsedForKYC(
		boolean isDocumentUsedForKYC) {

		return getPersistence().countByIsDocumentUsedForKYC(
			isDocumentUsedForKYC);
	}
