...
/**
 * Provides the local service interface for LeaveCompensatoryStatusMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LeaveCompensatoryStatusMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LeaveCompensatoryStatusMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ax.hrms.master.service.impl.LeaveCompensatoryStatusMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the leave compensatory status master local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LeaveCompensatoryStatusMasterLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public LeaveCompensatoryStatusMaster addLeaveCompensatoryStatusMaster(
	...
	public LeaveCompensatoryStatusMaster createLeaveCompensatoryStatusMaster(
	...
	public LeaveCompensatoryStatusMaster deleteLeaveCompensatoryStatusMaster(
		LeaveCompensatoryStatusMaster leaveCompensatoryStatusMaster);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LeaveCompensatoryStatusMaster fetchLeaveCompensatoryStatusMaster(
		long leaveCompensatoryStatusMasterId);
	...
	public LeaveCompensatoryStatusMaster findByLeaveCompensatoryStatusName(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LeaveCompensatoryStatusMaster getLeaveCompensatoryStatusMaster(
			long leaveCompensatoryStatusMasterId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LeaveCompensatoryStatusMaster>
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LeaveCompensatoryStatusMaster updateLeaveCompensatoryStatusMaster(
		LeaveCompensatoryStatusMaster leaveCompensatoryStatusMaster);
