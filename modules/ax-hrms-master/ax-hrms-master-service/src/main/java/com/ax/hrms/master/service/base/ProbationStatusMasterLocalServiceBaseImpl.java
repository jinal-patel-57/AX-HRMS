...
/**
 * Provides the base implementation for the probation status master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ax.hrms.master.service.impl.ProbationStatusMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ax.hrms.master.service.impl.ProbationStatusMasterLocalServiceImpl
 * @generated
 */
public abstract class ProbationStatusMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProbationStatusMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProbationStatusMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ax.hrms.master.service.ProbationStatusMasterLocalServiceUtil</code>.
	 */
	...
	public ProbationStatusMaster addProbationStatusMaster(
		...
		return probationStatusMasterPersistence.update(probationStatusMaster);
	}
	...
	public ProbationStatusMaster createProbationStatusMaster(
		...
		return probationStatusMasterPersistence.create(probationStatusMasterId);
	}
	...
	public ProbationStatusMaster deleteProbationStatusMaster(
		...
		return probationStatusMasterPersistence.remove(probationStatusMasterId);
	}
	...
	public ProbationStatusMaster deleteProbationStatusMaster(
		...
		return probationStatusMasterPersistence.remove(probationStatusMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return probationStatusMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProbationStatusMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return probationStatusMasterPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return probationStatusMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProbationStatusMaster fetchProbationStatusMaster(
		...
		return probationStatusMasterPersistence.fetchByPrimaryKey(
	...
	public ProbationStatusMaster getProbationStatusMaster(
		...
		return probationStatusMasterPersistence.findByPrimaryKey(
			probationStatusMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProbationStatusMaster.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return probationStatusMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProbationStatusMasterLocalServiceImpl#deleteProbationStatusMaster(ProbationStatusMaster) to avoid orphaned data");
		}

		return probationStatusMasterLocalService.deleteProbationStatusMaster(
			(ProbationStatusMaster)persistedModel);
	}

	@Override
	public BasePersistence<ProbationStatusMaster> getBasePersistence() {
		return probationStatusMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return probationStatusMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProbationStatusMaster> getProbationStatusMasters(
		...
		return probationStatusMasterPersistence.findAll(start, end);
	}
	...
	public int getProbationStatusMastersCount() {
		return probationStatusMasterPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		probationStatusMasterLocalService =
			(ProbationStatusMasterLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProbationStatusMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				probationStatusMasterPersistence.getDataSource();
	...
	protected ProbationStatusMasterLocalService
		probationStatusMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProbationStatusMasterLocalServiceBaseImpl.class);
